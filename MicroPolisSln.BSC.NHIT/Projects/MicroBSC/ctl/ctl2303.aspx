<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ctl2303.aspx.cs" Inherits="ctl_ctl2103" %>
...
<body>
    ...
    <div>
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                <td style="width: 100px; background-color: #efefef">
                <table border=0 width=300>
                    <tr>
                        <td>평가 부서코드 선택</td>
                        <td><asp:DropDownList ID="ddlEstTermInfo" runat="server">
                    </asp:DropDownList>&nbsp;<asp:ImageButton ID="iBtnSearch" runat="server" ImageUrl="../images/btn/b_033.gif"
