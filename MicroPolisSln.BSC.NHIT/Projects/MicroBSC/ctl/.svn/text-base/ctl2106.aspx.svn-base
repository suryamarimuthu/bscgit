<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ctl2106.aspx.cs" Inherits="ctl_ctl2106" %>
...
<!--
        ...
        function UltraWebGrid1_DblClickHandler(gridName, cellId) {
            ...
            var empid = row.getCellFromKey("EMP_REF_ID").getValue();
            var deptid = row.getCellFromKey("DEPT_REF_ID").getValue();
            var empName = row.getCellFromKey("EMP_NAME").getValue();

            var objKey = eval("opener.document.forms[0]." + document.forms[0].hdfObjKey.value);
            var objVal = eval("opener.document.forms[0]." + document.forms[0].hdfObjVal.value);

            objKey.value = empid;
            objVal.value = empName;
            window.close();
        }
        ...
        <tr class="cssPopContent">
            <td>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="height: 100%;">
                    <tr style="height:100%;">
                        <td width="250">
                            <div style="border: #F4F4F4 1px solid; overflow: auto; width: 240; height: 100%">
                        ...
                        <td>
                            <ig:UltraWebGrid ID="UltraWebGrid1" runat="server" Width="100%" Height="100%" OnInitializeRow="UltraWebGrid1_InitializeRow">
                                ...
                                <DisplayLayout CellPaddingDefault="2" Version="4.00" AllowSortingDefault="Yes" AllowColSizingDefault="Free"
                                    ...
                                    <ClientSideEvents DblClickHandler="UltraWebGrid1_DblClickHandler" MouseOverHandler="MouseOverHandler" />
