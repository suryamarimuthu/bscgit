...
public partial class CTL_CTL_MENU : AppPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if (!CHECHBOX_YN.Equals("Y"))
            {
                ...
                TreeViewCommom.BindMenu(TreeView1, false, TreeNodeSelectAction.Select, null);
            }
            else
            {
                TreeViewCommom.BindMenu(TreeView1, ibnSelect.Visible, TreeNodeSelectAction.None, CTRL_VALUE_VALUE);
            }
        }
    ...
    protected void TreeView1_SelectedNodeChanged(object sender, EventArgs e)
    {
        ...
        if (!TreeView1.SelectedNode.Value.Equals(""))
        {
            ...
            {
                Response.Write("opener.document.getElementById('" + CTRL_VALUE_VALUE + "').value='" + TreeView1.SelectedNode.Value + "';\r\n");
