<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DOC0701S1.aspx.cs" Inherits="_common_Draft_DOC0701S1" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function OpenDraftPrint() {
            ...
            var draft_status = "<%= Biz_Type.app_draft_select %>";
            var ymd = selRow.getCellFromKey("YMD").getValue();
            var url = "BSC0901P1.aspx?DRAFT_STATUS=" + draft_status + "&ESTTERM_REF_ID=" + estterm_ref_id + "&KPI_REF_ID=" + kpi_ref_id + "&BIZ_TYPE=" + biz_type + "&APP_REF_ID=" + app_ref_id + "&YMD=" + ymd;
                    ...
                    <Bands>
                        <ig:UltraGridBand>
                            ...
                            <Columns>
                                ...
                                <ig:UltraGridColumn BaseColumnName="KPI_NAME" HeaderText="KPI 명" Key="KPI_NAME" Width="250px">
                                ...
                                <ig:UltraGridColumn BaseColumnName="CHAMPION_EMP_NAME" HeaderText="담당자" Key="CHAMPION_EMP_NAME" Width="80px">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <Header Caption="담당자">
                                    </Header>
                                    <CellStyle HorizontalAlign="Center">
                                ...
                                <ig:UltraGridColumn BaseColumnName="RESULT_MS" HeaderText="당월실적" Key="RESULT_MS" Width="60px">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <Header Caption="당월실적">
                                    </Header>
                                ...
                                <ig:UltraGridColumn BaseColumnName="RESULT_TS" HeaderText="누적실적" Key="RESULT_TS" Width="60px">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <Header Caption="누적실적">
                                    </Header>
                                    <CellStyle HorizontalAlign="Right">
                                ...
                                <ig:UltraGridColumn BaseColumnName="SIGNAL_MS" HeaderText="당" Key="SIGNAL_MS" Width="20px">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <Header Caption="당">
                                    </Header>
                                    <CellStyle HorizontalAlign="Center">
                                ...
                                <ig:UltraGridColumn BaseColumnName="SIGNAL_TS" HeaderText="누" Key="SIGNAL_TS" Width="20px">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <Header Caption="누">
                                    </Header>
                                    <CellStyle HorizontalAlign="Center">
                                ...
                                <ig:UltraGridColumn BaseColumnName="APPROVAL_STATUS" Key="APPROVAL_STATUS" Hidden="true"></ig:UltraGridColumn>
