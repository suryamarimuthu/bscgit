...
function tmR(tmW) {
	...
	tmX.style.display = (tmW?'black':'block');
...
function tmS(tmb) {
	...
	tmY('i_txt'+this.tm4.tmC+'_'+this.tmC).style.color = tmb?'#101070':'#4876ED';
...
function tmT() {
	...
	return '<table cellspacing="0" cellpadding="0" border="0"><tr><td nowrap>'+
			...
			'<a href="#" onclick="GoMenuLink(\''+this.tm3[1]+'\',\'U2\');return trees['+this.tm4.tmC+'].tmG('+this.tmC+');" ondblclick="trees['+this.tm4.tmC+'].tmB('+this.tmC+')" onmouseover="trees['+this.tm4.tmC+'].tmJ('+this.tmC+');RMenuCtl('+this.tmC+',\''+this.tm3[1]+'\',\''+this.tm4.tm2['target']+'\',true);" onmouseout="trees['+this.tm4.tmC+'].tmH('+this.tmC+');RMenuCtl('+this.tmC+',\'\',\'\',false);" class="t'+this.tm4.tmC+'i" style="color:#101070;font-family:tahoma,verdana,ttche,arial;" id="i_txt'+this.tm4.tmC+'_'+this.tmC+'">'+
			'<img src="'+this.tmP()+'" border="0" align="absbottom" name="i_img'+this.tm4.tmC+'_'+this.tmC+'" class="t'+this.tm4.tmC+'im">'+this.tm3[0]+'</a>'+
			'</td></tr></table>'+(this.tmK.length?'<div id="i_div'+this.tm4.tmC+'_'+this.tmC+'" style="display:block"></div>':'');
...
var icon_imgpath = '../../../image/menu/'; // Path of ICON Image

var tree_tpl = {
	'target'  : 'MBSCMain', // Target link

	'icon_e' : icon_imgpath+'empty.gif', // Blank Image
	'icon_l' : icon_imgpath+'line.gif',  // Base bar image 

	'icon_32' : icon_imgpath+'../list_icon_00.gif',   // root leaf icon normal
	'icon_36' : icon_imgpath+'../list_icon_00.gif',   // root leaf icon selected
	'icon_48' : icon_imgpath+'../list_icon_00.gif',   // root icon normal
	'icon_52' : icon_imgpath+'../list_icon_02.gif',   // Root Icon image by hidden sub menu
	'icon_56' : icon_imgpath+'../list_icon_00.gif',   // root icon image on Loading page
	'icon_60' : icon_imgpath+'../list_icon_00.gif',   // root icon image selected 
	
	'icon_16' : icon_imgpath+'../list_icon_05.gif', // Group(Folder) Icon
	'icon_20' : icon_imgpath+'../list_icon_05.gif', // Group Icon Image selected
	'icon_24' : icon_imgpath+'folderopen.gif', // Group Icon Image selected sub menu
	'icon_28' : icon_imgpath+'folderopen.gif', // Group Icon Image selected as open sub menu 

	'icon_0' : icon_imgpath+'../list_icon_04.gif', // Page icon image 
	'icon_4' : icon_imgpath+'../list_icon_04.gif', // Page icon image selected
	
	'icon_2' : icon_imgpath+'joinbottom.gif', // dot line icon image 
	'icon_3' : icon_imgpath+'join.gif',       // dot line icon image last 
	'icon_18' : icon_imgpath+'plusbottom.gif', // + icon image
	'icon_19' : icon_imgpath+'plus.gif',       // + icon image at last group 
	'icon_26' : icon_imgpath+'minusbottom.gif',// - icon image at open sub menu
	'icon_27' : icon_imgpath+'minus.gif'       // - icon image at open last sub menu 
};
