...
function igdrp_combo(elem,props,ce)
{
	...
	this._keepDrop=function(){if(this.Element.offsetWidth<2)this.setDropDownVisible(false);}
	this.setDropDownVisible=function(bDrop,foc)
	{
		...
		igdrp_all._dropTimer=window.setInterval('if(typeof igdrp_evt=="function")igdrp_evt(1)',200);
	}
