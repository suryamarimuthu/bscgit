...
function UltraWebListbar(id,groups){
	...
	if((this.ViewType = props[3]) == 0)
	{
		...
		if((ig_shared.IsIE6 || ig_shared.IsIE7 || ig_shared.IsIE55) && document.documentElement != null)
		{
		    var totalHeight = this.Element.offsetHeight;
		    var elem = ig.getElementById(id+"_Items").offsetParent.offsetParent.parentNode;
