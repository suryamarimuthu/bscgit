...
function IGBrowser() 
{
	...
	this.IsIE8              = this.AgentName.indexOf("msie 8") != -1;
...
function IGCrossHair(id, toggleOnClick)
{
	...
	this.Render = function(b) 
	{
	    ...
	    if (IGB.IsFirefox && chartElement && xHairOffsetParent && xHairOffsetParent.tagName == "body" && xHairOffsetParent != chartElement && xHairOffsetParent != chartElement.offsetParent) 
	    {
