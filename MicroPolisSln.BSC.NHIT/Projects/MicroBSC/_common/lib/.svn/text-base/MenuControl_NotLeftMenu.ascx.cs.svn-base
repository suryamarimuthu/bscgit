...
public partial class _common_lib_MenuControl_Dept_NotLeft : AppUserControlBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (PageUtility.IsContainSystemAdminUser(gUserInfo.Emp_Ref_ID))
            {
                lblTitle.Text = "관점별 현황";
                //leftTopTitle.ImageUrl = "~/images/left/le_c02.gif";
            }
            else 
            {
                lblTitle.Text = "조직상황판";
                //leftTopTitle.ImageUrl = "~/images/left/le_c06.gif";
            }
        }
        else
        {
