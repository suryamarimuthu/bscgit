<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MenuControl_FrameTop.ascx.cs" Inherits="MenuControl_FrameTop_NHIT" %>
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td width="190" align="center">
                                                            &nbsp;<a href="<%=GetRootPagePath("/mgr/svr4100.aspx")%>"><img ID="ImageButton1" src="~/images/btn/top_bu_k01_b.gif" border="0" runat="server" /></a>
                                                            <a href="<%=GetRootPagePath("/usr/usr3010.aspx")%>"><img ID="ImageButton2" src="~/images/btn/top_bu_k02_b.gif"  border="0" runat="server" /></a></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
