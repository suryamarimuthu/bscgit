<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EST_DEPT.aspx.cs" Inherits="EST_EST_DEPT" %>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr> 
                                        <td height="40" valign="top" background="../images/title/popup_t_bg.gif"> 
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr> 
                                                    <td height="40" valign="top"><img src="../images/title/popup_t70.gif" ></td>
                                        ...
                                        <td valign="top" align="center">
                                            <div>
                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 98%">
                                                    <tr>
                                                        <td>
                                                            <div style="border:#F4F4F4 3px solid; overflow: auto; width: 100%; height: 300px">
                                                        ...
                                                        <td height="40">
                                                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                                <tr>
                                                                    <td>
                                                                        &nbsp;
                                                                        <asp:CheckBox ID="ckbAll" runat="server" onclick="selectChkBox(this, 'TreeView1');" Text="전체선택/해제" />
                                                                    </td>
                                                                    <td align="right">
                                                                        <ASP:IMAGEBUTTON id="ibnSelect" runat="server" imageurl="../images/btn/b_094.gif" OnClick="ibnSelect_Click"/>
