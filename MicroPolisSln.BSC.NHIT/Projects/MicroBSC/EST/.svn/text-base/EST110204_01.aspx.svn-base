<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeFile="EST110204_01.aspx.cs" Inherits="EST_EST110204_01" %>
...
//            return false;
    ...
    var deptPopup;
    function fnDeptPopup()
    {
        deptPopup = gfOpenWindow( "EST_DEPT1.aspx?ESTTERM_REF_ID="	    + '<%= IESTTERM_REF_ID %>'
                                + "&CTRL_DEPT_VALUE_NAME="	+ "hdfDeptRefId"
                                + "&CTRL_DEPT_TEXT_NAME="	+ "txtDeptName"
                                + "&CTRL_EMP_VALUE_NAME="	+ "hdfEmpRefId"
                                + "&CTRL_EMP_TEXT_NAME="	+ "txtEmpName"
    ...
    <%--
    function fnDeptSelect(id, name, winObj)
    {
        document.getElementById("<%=txtDEPTNAME1.ClientID %>").value = name;
        document.getElementById("<%=hdfDeptRefId1.ClientID %>").value = id;
        winObj.close();
    }
    --%>
</script>
                    ...
                    <tr>
                        ...
                        <td class="cssTblContent">
                            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                                <tr>
                                    <td>
                                        <asp:TextBox id="txtDEPTNAME1" ReadOnly="true" runat="server" width="65%"></asp:TextBox>
                                        <asp:HiddenField id="hdfDeptRefId1" runat="server"></asp:HiddenField>
                                    </td>
                                    <td style="width:85px;" align="right">
                                        <asp:ImageButton id="ibtnEmpSearch1" runat="server" imageUrl="../images/btn/b_034.gif" onClientClick="return fnDeptPopup();" ImageAlign="AbsMiddle"></asp:ImageButton>
                                    </td>
                                </tr>
                            </table>
                        </td>--%>
            ...
            <td>
                ...
                <ig:UltraWebGrid ID="ugrdMBO" runat="server" Width="100%" Height="100%" OnInitializeRow="ugrdMBO_InitializeRow" OnInitializeLayout="ugrdMBO_InitializeLayout">
                    <Bands>
                        <ig:UltraGridBand>
                            <Columns>
                                <ig:UltraGridColumn BaseColumnName="KPI_CODE" Key="KPI_CODE" Width="40px" HeaderText="" Hidden="true">
                                ...
                                <ig:UltraGridColumn BaseColumnName="ESTTERM_STEP_NAME" Key="ESTTERM_STEP_NAME" Width="45px" HeaderText="단계"  Hidden="true">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="true" />
                                    <Header><RowLayoutColumnInfo OriginX="3" /></Header>
                                    <CellStyle HorizontalAlign="Center">
                                    </CellStyle>
                                </ig:UltraGridColumn>
                                <ig:UltraGridColumn BaseColumnName="KPI_GROUP_NAME" Key="KPI_GROUP_NAME" Width="40px" HeaderText="지표<br />유형"  Hidden="true">
                                    <HeaderStyle HorizontalAlign="Center" />
                                ...
                                <ig:UltraGridColumn BaseColumnName="UNIT_NAME" Key="UNIT_NAME" Width="30px" HeaderText="단위"  Hidden="true">
                                    <HeaderStyle HorizontalAlign="Center" />
                                ...
                                <ig:UltraGridColumn BaseColumnName="TARGET_TS" Key="TARGET_TS" Width="60px" Format="###,###,##0.####" HeaderText="목표">
                                    <HeaderStyle HorizontalAlign="Center" />
                                    <Header><RowLayoutColumnInfo OriginX="9" /></Header>
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                </ig:UltraGridColumn>
                                <ig:UltraGridColumn BaseColumnName="RESULT_TS" Key="RESULT_TS" Width="60px" Format="###,###,##0.####" HeaderText="실적">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="true" />
                                    <Header><RowLayoutColumnInfo OriginX="10" /></Header>
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                </ig:UltraGridColumn>
                                <ig:UltraGridColumn BaseColumnName="ACHIEVEMENT_RATE" Key="ACHIEVEMENT_RATE" Width="60px" Format="###,###,##0.#" HeaderText="달성율">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="true" />
                                ...
                                <ig:UltraGridColumn BaseColumnName="APP_STATUS" Key="APP_STATUS" Width="50px" HeaderText="결재">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="true" />
                                    <Header><RowLayoutColumnInfo OriginX="17" /></Header>
                                    <CellStyle HorizontalAlign="Center">
                                    </CellStyle>
                                </ig:UltraGridColumn>
                                <ig:UltraGridColumn BaseColumnName="SCORE_WEIGHT" Key="SCORE_WEIGHT" Format="###,###,##0.####" Width="60px" HeaderText="가.점수">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="true" />
                                    <Header><RowLayoutColumnInfo OriginX="18" /></Header>
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                </ig:UltraGridColumn>
                                <ig:UltraGridColumn BaseColumnName="SCORE_ORI" Key="SCORE_ORI" Format="###,##0.##" EditorControlID="igtxtNum" AllowUpdate="No" Type="Custom" Width="60px" HeaderText="평.점수">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="true" />
                                ...
                                <ig:UltraGridColumn BaseColumnName="GRADE" Key="GRADE_POP" Width="40px" HeaderText="채점">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="true" />
                                ...
                                <ig:TemplatedColumn BaseColumnName="TARGET" Key="TARGET"  Width="80px" HeaderText="정의서">
                                    <HeaderStyle HorizontalAlign="Center" Wrap="true" />
                                    <Header><RowLayoutColumnInfo OriginX="24" /></Header>
                                    <CellStyle HorizontalAlign="Center">
                                    </CellStyle>
                                    <CellTemplate>
                                ...
                                <ig:UltraGridColumn BaseColumnName="SCORE_DT" Key="SCORE_DT" HeaderText="SCORE_DT" Hidden="true"></ig:UltraGridColumn>
                                <ig:UltraGridColumn BaseColumnName="RATIO_DT" Key="RATIO_DT" HeaderText="RATIO_DT" Hidden="true"></ig:UltraGridColumn>
                                <ig:UltraGridColumn BaseColumnName="SCORE_MT" Key="SCORE_MT" HeaderText="SCORE_MT" Hidden="true"></ig:UltraGridColumn>
                                <ig:UltraGridColumn BaseColumnName="RATIO_MT" Key="RATIO_MT" HeaderText="RATIO_MT" Hidden="true"></ig:UltraGridColumn>
                                <ig:UltraGridColumn BaseColumnName="FINAL_SCORE" Key="FINAL_SCORE" HeaderText="FINAL_SCORE" Hidden="true"></ig:UltraGridColumn>
                            </Columns>
                        </ig:UltraGridBand>
                    </Bands>
