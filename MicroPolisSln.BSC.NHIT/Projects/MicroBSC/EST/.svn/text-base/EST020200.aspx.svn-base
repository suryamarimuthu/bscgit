<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EST020200.aspx.cs" Inherits="EST_EST020200" %>
...
<script type="text/javascript">
	...
	function CheckForm()
	{
		if ( document.all.txtColStyleID.value.length == 0 )
		{
			alert( "컬럼스타일ID를 입력해주세요." );
			document.all.txtEstTermSubID.focus();
			return false;
		}	
		else if ( document.all.txtColStyleName.value.length == 0 )
		{
			alert( "컬럼스타일명을 입력해주세요." );
			document.all.txtColStyleName.focus();			
			return false;
		}
                    ...
                    <tr>
                        ...
                        <td class="cssTblContent">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td>
                                        <asp:textbox id="txtColStyleID" runat="server" MaxLength="10" Width="100%" Enabled="false"></asp:textbox>
                                    </td>
                                    <td style="width:90px;">
                        ...
                        <td class="cssTblTitle">
                            컬럼스타일명</td> 
                        <td class="cssTblContent">
                            <asp:textbox id="txtColStyleName" runat="server" MaxLength="50" Width="100%"></asp:textbox>
                        </td> 
                    </tr>
                </table>
            </td>
