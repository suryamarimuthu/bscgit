...
public partial class EST_EST_DEPT : EstPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            if(!CHECHBOX_YN.Equals("Y")) 
            {
                ...
                TreeViewCommom.BindDept(TreeView1, false, TreeNodeSelectAction.Select, null);
            }
            else 
            {
                TreeViewCommom.BindDept(TreeView1, ibnSelect.Visible, TreeNodeSelectAction.None, CTRL_VALUE_VALUE);
            }
        }
