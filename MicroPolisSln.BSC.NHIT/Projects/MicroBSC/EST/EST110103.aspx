<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EST110103.aspx.cs" Inherits="EST_EST110103" %>
					                                            ...
					                                            <Bands>
						                                            <ig:UltraGridBand>
							                                            ...
							                                            <Columns>
								                                            ...
								                                            <ig:UltraGridColumn BaseColumnName="TGT_POS_KND_ID" Key="POS_KND_ID" Hidden="True">
                                                                                <Header>
								                                            ...
								                                            <ig:UltraGridColumn BaseColumnName="TGT_EMP_NAME" Key="TGT_EMP_NAME" Width="80px" HeaderText="피평가자명">
									                                            <HeaderStyle HorizontalAlign="Center" />
									                                            <Header Caption="피평가자명">
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" width="100%">
	                                                            <tr>
                                                                    ...
                                                                    <td style="height: 40px" align="right">
                                                                        ...
                                                                        <asp:ImageButton ID="ibnConfirmAssingPosBiz" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/btn/b_195.gif" Visible="false" OnClick="ibnConfirmAssingPosBiz_Click" CommandName="BIZ_CONFIRM_ASSIGN_POS_BIZ"/>
