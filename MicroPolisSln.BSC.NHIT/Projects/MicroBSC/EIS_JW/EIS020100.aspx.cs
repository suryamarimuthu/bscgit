...
public partial class EIS_EIS020100 : EstPageBase
{
    ...
    private void DataBinding() 
    {
        ...
        //DataTable dt1 = DataTypeUtility.FilterSortDataTable(DT_DATA, string.Format("KPI_REF_ID = {0}", 1371));
        DataTable dt1 = DataTypeUtility.FilterSortDataTable(DT_DATA, string.Format("KPI_REF_ID = {0}", 1393));
