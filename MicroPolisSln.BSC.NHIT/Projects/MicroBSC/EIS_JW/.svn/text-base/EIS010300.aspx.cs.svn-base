...
public partial class EIS_EIS010300 : EstPageBase
{
    ...
    private DataTable DT_DATA_01;
    private DataTable DT_DATA_02;
    ...
    private void SetData(int estterm_ref_id, string ymd) 
    {
        ...
        DT_DATA_01             = objEIS.GetData_M_1_S_3_A(estterm_ref_id, ymd);
        DT_DATA_02             = objEIS.GetData_M_1_S_3_B(estterm_ref_id, ymd);
