<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EIS040400.aspx.cs" Inherits="EIS_EIS040400" %>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td align="center">
                                            ...
                                            <div align="left">&nbsp;&nbsp;&nbsp;합계 : <asp:Label ID="lbl1" runat="server" Font-Bold="true" Font-Size="Medium"></asp:Label> 백만원</div> 
                                        </td>
                                        <td>
                                            ...
                                            <div align="left">&nbsp;&nbsp;&nbsp;합계 : <asp:Label ID="lbl2" runat="server" Font-Bold="true" Font-Size="Medium"></asp:Label> 백만원</div> 
                                        </td>
                                            ...
                                            <ig:UltraWebGrid id="uGrid" runat="server" Width="100%" Height="320px" 
								                ...
								                <Bands>
									                <ig:UltraGridBand>
									                    ...
									                    <Columns>
										                    <ig:UltraGridColumn BaseColumnName="ALIAS" Key="ALIAS" Width="80px" MergeCells="true">
										                    ...
										                    <ig:UltraGridColumn BaseColumnName="GB" Key="GB" Width="80px">
											                    <Header Caption="구분">
										                    ...
										                    <ig:UltraGridColumn BaseColumnName="TARGET_MS" Key="TARGET_MS" Width="60px" Format="#,##0">
											                    <Header Caption="목표">
										                    ...
										                    <ig:UltraGridColumn BaseColumnName="RESULT_MS" Key="RESULT_MS" Width="60px" Format="#,##0">
											                    <Header Caption="실적">
										                    ...
										                    <ig:UltraGridColumn BaseColumnName="BF_RNF_RATE" Key="BF_RNF_RATE" Width="70px" Format="#,##0">
