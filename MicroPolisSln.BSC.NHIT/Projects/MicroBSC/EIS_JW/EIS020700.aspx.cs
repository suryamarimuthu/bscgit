...
public partial class EIS_EIS020700 : EstPageBase
{
    ...
    private void SetData(int estterm_ref_id, string ymd) 
    {
        ...
        DS_DATA             = objEIS.GetData_M_2_S_7(estterm_ref_id, ymd);
    ...
    private void DataBinding() 
    {
        ...
        BindChart(Chart1
                , dt
                , string.Format("주요제품별 {0}년 계획대비추정실적", YMD.Substring(2, 2)));
    }
                        ...
                        , string titleName)
    {
        ...
        for(int i = 0; i < dt.Rows.Count; i++) 
        {
            series2.Points.AddY(dt.Rows[i]["EXPT_RESULT_TS_SUM"]);
        }
