<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EIS040100.aspx.cs" Inherits="EIS_EIS040100" %>
                        ...
                        <tr height="40%">
                            <td valign="top">
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr height="20px">
                                        <td width="25%">
                                            <img align="absMiddle" src="../images/arrow/arrow.gif"/> <b>매출액</b>
                                        </td>
                                        <td width="25%" align="right">
                                            (단위:백만원)&nbsp;&nbsp;&nbsp;&nbsp;
                                        </td>
                                        <td width="25%">
                                            <img align="absMiddle" src="../images/arrow/arrow.gif"/> <b>매출총이익</b>
                                        </td>
                                        <td align="right">
                                            (단위:백만원)&nbsp;&nbsp;&nbsp;&nbsp;
                                        </td>
