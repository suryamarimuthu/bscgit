<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EIS030100.aspx.cs" Inherits="EIS_EIS030100" %>
            ...
            <tr>
                <td style="height: 100%" valign="top">
                    <table style="width: 100%; height: 100%" border="0" cellpadding="0" cellspacing="0">
                        <tr height="40%">
                            <td valign="top">
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr height="20px">
                                        <td width="25%">
                                            <img align="absMiddle" src="../images/arrow/arrow.gif"/> <b>Global 매출액</b>
                                        </td>
                                        <td width="25%" align="right">
                                            (단위:백만원)&nbsp;&nbsp;&nbsp;&nbsp;
                                        </td>
                                        <td width="25%">
                                            <img align="absMiddle" src="../images/arrow/arrow.gif"/> <b>Global 영업이익</b>
                                        </td>
                                        <td align="right">
                                            (단위:백만원)&nbsp;&nbsp;&nbsp;&nbsp;
                                        </td>
                        ...
                        <tr>
                            <%--<td style="vertical-align: top; height:expression(eval(document.body.clientHeight)- 420); ">--%>
                            <td>
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr height="20px">
                                        <td>
                                            <img align="absMiddle" src="../images/arrow/arrow.gif"/> <b>매출 및 손익현황</b>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <ig:UltraWebGrid id="uGrid" runat="server" Width="100%" Height="150px" 
								                ...
								                <Bands>
									                <ig:UltraGridBand>
									                    ...
									                    <Columns>
										                    ...
										                    <ig:UltraGridColumn BaseColumnName="TARGET_MS" Key="TARGET_MS" Width="100px" Format="#,##0">
											                    <Header Caption="목표">
										                    ...
										                    <ig:UltraGridColumn BaseColumnName="RESULT_MS" Key="RESULT_MS" Width="100px" Format="#,##0">
											                    <Header Caption="실적">
										                    ...
										                    <ig:UltraGridColumn BaseColumnName="ACHIVE_RATE_MS" Key="ACHIVE_RATE_MS" Width="100px" Format="#,##0">
											                    <Header Caption="달성율(%)">
										                    ...
										                    <ig:UltraGridColumn BaseColumnName="TARGET_TS" Key="TARGET_TS" Width="100px" Format="#,##0">
											                    <Header Caption="목표">
										                    ...
										                    <ig:UltraGridColumn BaseColumnName="RESULT_TS" Key="RESULT_TS" Width="100px" Format="#,##0">
											                    <Header Caption="실적">
										                    ...
										                    <ig:UltraGridColumn BaseColumnName="ACHIVE_RATE_TS" Key="ACHIVE_RATE_TS" Width="100px" Format="#,##0">
											                    <Header Caption="달성율(%)">
										                    ...
										                    <ig:UltraGridColumn BaseColumnName="BF_RESULT_TS" Key="BF_RESULT_TS" Width="100px" Format="#,##0">
										                    ...
										                    <ig:UltraGridColumn BaseColumnName="RNF_RATE" Key="RNF_RATE" Width="100px" Format="#,##0">
											                    <Header Caption="증감율(%)">
								                ...
								                <FrameStyle Cursor="hand" BackColor="Window" BorderColor="#E9EBEB" 
                                                        ...
                                                        Font-Size="8.25pt" Height="140px" Width="100%">
								                </FrameStyle>
								                <Pager>
                        ...
                        <tr height="20%">
                            <td>
                                ...
                                <iframe id="ifmContent" runat="server" frameborder="0" width="100%" height="80px" marginwidth="0" marginheight="0" scrolling="no"></iframe>
                            </td>
                        </tr>
                    </table>
                </td>
