<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R005.aspx.cs" Inherits="eis_SEM_Mana_R005" %>
            ...
            <div>
                ...
                <table width="800px" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
                    <tr> 
                        ...
                        <td class="box_td01">
                            <ig:WebDateChooser ID="sDate" runat="server">
                            </ig:WebDateChooser>
                        </td>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>지구별현황</strong></font></td>
                                   ...
                                   <ig:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="135px"
                                            ...
                                            <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                                                ...
                                                <FrameStyle BackColor="Window" BorderColor="#E9EBEB" BorderStyle="Solid"
                                                    BorderWidth="3px" Font-Names="Microsoft Sans Serif" Font-Size="8.25pt" Height="160px"
                                                    Width="100%">
                                                </FrameStyle>
                                                <Pager>
