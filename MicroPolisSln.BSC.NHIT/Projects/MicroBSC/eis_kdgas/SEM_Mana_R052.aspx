<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R052.aspx.cs" Inherits="eis_SEM_Mana_R052" %>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="고객 상태별 점유율" src="../images/title_ic01.gif" align="left" /><font color="408BEF"><strong>고객 상태별 점유율</strong></font></td>
                                        </tr>
                                    </table>
	                                </td>
	                                <td align="center">
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="월별 고객 Status" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>월별 고객 Status</strong></font></td>
