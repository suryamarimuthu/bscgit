<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DailySupplyQnt.aspx.cs" Inherits="DailySupplyQnt" %>
            ...
            <div>
                ...
                <table width="800px" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
                    <tr> 
                        ...
                        <td align="center" bgcolor="A6C5D1"><strong><font color="#FFFFFF">구 분</font></strong></td>
                        <td class="box_td01">
                          <asp:RadioButtonList ID="rdoGbn" runat="server" RepeatColumns="2">
                            <asp:ListItem Value="HS" Selected="True">시간대별공급량</asp:ListItem>
                            <asp:ListItem Value="DS">일자별공급량</asp:ListItem>
                          </asp:RadioButtonList>
                        </td>
