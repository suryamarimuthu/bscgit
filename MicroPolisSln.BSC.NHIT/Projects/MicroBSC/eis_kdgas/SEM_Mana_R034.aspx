<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R034.aspx.cs" Inherits="eis_SEM_Mana_R034" %>
    ...
    <body style="margin:0 0 0 0 ; background-color:#FFFFFF">
        <form id="form1" runat="server">
            <div>
                ...
                <!--- MAIN START --->
                <!--- TITLE --->
    <table border="0" cellspacing="0" cellpadding="0" width="800px" style="height:100%" bgcolor="#FFFFFF">
        <tr>
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
                    <tr> 
                        ...
                        <td class="box_td01">
                            ...
                            <asp:DropDownList ID="cboArea" runat="server" Visible="false">
                            </asp:DropDownList>
                        </td>
	                            ...
	                            <tr>
	                                <td align="center">
	                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>동종사 공급비용 현황</strong></font>&nbsp;&nbsp;
                                                    <font color="CornflowerBlue"><strong>(※ 적용기간 : </strong>
                                                    <asp:Label ID="lblYear" runat="server" Text=""></asp:Label>7月 1日부터 
                                                    <asp:Label ID="lblNextYear" runat="server" Text=""></asp:Label>6月 30日까지<strong>)</strong></font> 
                                                </td>
