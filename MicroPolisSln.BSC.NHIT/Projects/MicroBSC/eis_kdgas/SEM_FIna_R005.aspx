<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_FIna_R005.aspx.cs" Inherits="SEM_FIna_R005" %>
...
<td valign="top" style="height:200" align="left">
     <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
        <tr>
            ...
            <td width="15%" align="center" bgcolor="A6C5D1"><strong><font color="#FFFFFF">계정코드</font></strong></td>
            <td class="box_td01">
                 <asp:DropDownList ID="cboActCd" runat="server" AppendDataBoundItems="True" EnableTheming="False">
                 </asp:DropDownList>
            </td>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="800px" height="95%" >
    	...
    	<table border=0 width=100%>
    	    <tr>
                <td><img alt="도시가스 이익 원단위 분석" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>도시가스 이익 원단위 분석</strong></font></td>
                <td align="right"><font color="408BEF"><strong>단위 : 천㎥,천원</strong></font>&nbsp;&nbsp;</td>
    	    </tr>
    	    <tr>
