<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R015.aspx.cs" Inherits="eis_SEM_Mana_R015" %>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="매출비중" src="../images/title_ic01.gif" align="left" /><font color="408BEF"><strong>매출량상세</strong></font></td>
                                            ...
                                            <ig:UltraGridBand>
                                                ...
                                                <Columns>
                                                    ...
                                                    <ig:UltraGridColumn BaseColumnName="SGBUN_CD" EditorControlID="" FooterText="" Format=""
                                                        HeaderText="구분코드" Key="SGBUN_CD" Width="120px" Hidden="true">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <Header Caption="구분코드">
