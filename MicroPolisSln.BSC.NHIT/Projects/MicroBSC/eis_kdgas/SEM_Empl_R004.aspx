<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Empl_R004.aspx.cs" Inherits="eis_SEM_Empl_R004" %>
        ...
        <form id="form1" runat="server">
            <div>
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="800px" height="95%" >
	                <tr>
	                    <td style="padding-left:5px;" height="300">
	                        <table border=0 width=100%>
	                            <tr>
	                                <td>
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>비용 집행 현황</strong></font></td>
