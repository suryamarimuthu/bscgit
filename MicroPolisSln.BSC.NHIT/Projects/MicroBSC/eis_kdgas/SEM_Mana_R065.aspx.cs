...
public partial class eis_SEM_Mana_R065 : EISPageBase
{
    int type = 0;
    ...
    private void _queryGrid()
    {
        ...
        arrOpm[2] = new OracleParameter("i_GUBUN", OracleType.VarChar, 8);
        arrOpm[2].Value = cboGbn.SelectedValue;
        arrOpm[3] = new OracleParameter("O_Mana_R065", OracleType.Cursor);
        ...
        arrOpmGrid[2] = new OracleParameter("i_GUBUN", OracleType.VarChar, 8);
        arrOpmGrid[2].Value = cboGbn.SelectedValue;
        arrOpmGrid[3] = new OracleParameter("O_Mana_R065", OracleType.Cursor);
    ...
    protected void iBtnGraph_Click(object sender, ImageClickEventArgs e)
    {
        if (Chart1.Visible)
        {
            UltraWebGrid1.Height = 450;
            Chart1.Visible = false;
        }
        else
        {
            UltraWebGrid1.Height = 150;
            Chart1.Visible = true;
        }
    }
