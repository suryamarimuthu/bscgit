<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R001.aspx.cs" Inherits="eis_SEM_Mana_R001" %>
        ...
        <form id="form1" runat="server">
            <div>
                ...
                <table width="800px" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
                    <tr> 
                        <td align="center" bgcolor="A6C5D1" style="width: 68px"><strong><font color="#FFFFFF">조회일자</font></strong></td>
                        <td class="box_td01" style="width: 117px">
                            <ig:WebDateChooser ID="sDate" runat="server" AllowNull="False">
                                <CalendarLayout AllowNull="False">
                                </CalendarLayout>
                            </ig:WebDateChooser>
                        </td>
                        <td align="center" bgcolor="A6C5D1" style="width: 57px"><strong><font color="#FFFFFF">사업장</font></strong></td>
                        <td class="box_td01" style="width: 89px">
                            <asp:DropDownList ID="cboTCom" runat="server" Visible="true" AutoPostBack="false">
                            </asp:DropDownList>
                        </td>
                        <td align="center" bgcolor="A6C5D1" style="width: 47px"><strong><font color="#FFFFFF">구 분</font></strong></td>
                        <td class="box_td01" style="width: 364px">
                            <asp:DropDownList ID="ddlGbn" runat="server" Visible="true" AutoPostBack="false"></asp:DropDownList>
                            <asp:DropDownList ID="ddlMT" runat="server" Visible="true" AutoPostBack="false"></asp:DropDownList>
                        </td>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>시간/일별 공급현황</strong></font></td>
                                            <td align="right"><font color="408BEF"><strong>단 위 : 천㎥, %</strong></font></td>
                                        </tr>
                                    </table>
	                                </td>
	                            </tr>
