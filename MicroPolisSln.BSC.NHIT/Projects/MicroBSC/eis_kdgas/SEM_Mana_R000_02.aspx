<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R000_02.aspx.cs" Inherits="eis_SEM_Mana_R000_02" %>
	                                ...
	                                <td style="width: 50%">
	                                     <table border="0" cellpadding="0" cellspacing="0" >
                                          ...
                                          <table width="395" border="0" cellpadding="0" cellspacing="0">
                                              <tr> 
                                                <td align="center" style="width: 422px"><b /> <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr> 
                                                      <td style="height: 17px"><img align="left" alt="" src="../images/title_ic01.gif" /><font color="#408bef"><strong style="height: 30px">공급량 (<asp:Label ID="lbl01" runat="server" Text=""></asp:Label>)</strong></font></td>
                                                    </tr>
                                                  </table></td>
                                              </tr>
                                              <tr> 
                                                <td style="height: 69px; width: 422px;">
                                                <DGWC:GaugeContainer id="GaugeContainer1" runat="server" backcolor="White" Height="150px" Width="420px" AutoLayout="False">
                                                     <CircularGauges>
                                                         ...
                                                         <DGWC:CircularPointer BorderWidth="0" CapFillColor="Silver" CapFillGradientEndColor="MediumTurquoise"
                                                             ...
                                                             <BackFrame BackColor="DeepSkyBlue" BackGradientEndColor="DarkBlue" BackGradientType="TopBottom"
                                              ...
                                              <tr>
                                                  <td align="center" style="width: 422px">
                                                      <table width="320" border="0" cellpadding="0" cellspacing="3">
                                                          <tr>
                                                              <td width="50%" align="center" style="height: 163px">
                                                                  <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                                                                      <tr>
                                                                          <td width="30%" height="28" align="center" bgcolor="#EAEAEA">
                                                                              계 &nbsp;획</td>
                                                                          <td bgcolor="#EFEFEF">
                                                                              <asp:TextBox ID="txtBrd1_1" runat="server" CssClass="eis_MainBox" Text="0" Width="100%" Font-Size="10pt"></asp:TextBox></td>
                                                                      </tr>
                                                                      <tr>
                                                                          <td height="28" align="center" bgcolor="#EAEAEA">
                                                                              실 &nbsp;적</td>
                                                                          <td bgcolor="#EFEFEF">
                                                                              <asp:TextBox ID="txtBrd1_2" runat="server" CssClass="eis_MainBox" Text="0" Width="100%" Font-Size="10pt"></asp:TextBox></td>
                                                                      </tr>
                                                                      <tr>
                                                                          <td height="28" align="center" bgcolor="#EAEAEA">
                                                                              전 &nbsp;년</td>
                                                                          <td bgcolor="#EFEFEF" style="height: 28px">
                                                                              <asp:TextBox ID="txtBrd1_3" runat="server" CssClass="eis_MainBox" Text="0" Width="100%" Font-Size="10pt"></asp:TextBox></td>
                                                                      </tr>
                                                                      <tr>
                                                                          <td width="30%" height="28" align="center" bgcolor="#EAEAEA">
                                                                              달성율</td>
                                                                          <td bgcolor="#EFEFEF">
                                                                              <asp:TextBox ID="txtBrd1_4" runat="server" CssClass="eis_MainBox" Text="0" Width="100%" Font-Size="10pt"></asp:TextBox></td>
                                                                      </tr>
                                                                      <tr>
                                                                          <td align="center" bgcolor="#EAEAEA" style="height: 28px">
                                                                              성장율</td>
                                                                          <td bgcolor="#EFEFEF" style="height: 28px">
                                                                              <asp:TextBox ID="txtBrd1_5" runat="server" CssClass="eis_MainBox" Text="0" Width="100%" Font-Size="10pt"></asp:TextBox></td>
                                                                      </tr>
                                                   ...
                                                   <table width="395" border="0" cellpadding="0" cellspacing="0">
                                                               ...
                                                               <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                   <tr>
                                                                       <td style="height: 17px">
                                                                           <img align="left" alt="" src="../images/title_ic01.gif" /><font color="#408bef"><strong style="height: 30px">수요개발 (<asp:Label ID="lbl02" runat="server" Text=""></asp:Label>)</strong></font></td>
                                                                   </tr>
                                                               </table>
                                                           </td>
                                                       </tr>
                                                       <tr>
                                                           <td style="height: 69px">
                                                               <DGWC:GaugeContainer id="GaugeContainer2" runat="server" backcolor="White" Height="150px" Width="420px" AutoLayout="False">
                                                                   <CircularGauges>
                                                                       <DGWC:CircularGauge Name="Default">
                                                                           <Scales>
                                                                           ...
                                                                           <PivotPoint X="50" Y="82" />
                                                                           <Pointers>
                                                                               <DGWC:CircularPointer BorderWidth="0" CapFillColor="Silver" CapFillGradientEndColor="MediumTurquoise" CapFillGradientType="None" CapReflection="True" CapWidth="21" DistanceFromScale="1"
                                                                                 FillColor="Red" FillGradientEndColor="Maroon" Name="Default" Placement="Outside"                                                                Width="14" />
                                                                           </Pointers>
                                                                           ...
                                                                           <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                                                                               <tr>
                                                                                   <td width="30%" height="28" align="center" bgcolor="#EAEAEA">
                                                                                       계 &nbsp;획</td>
                                                                                   <td bgcolor="#EFEFEF">
                                                                                       <asp:TextBox ID="txtBrd2_1" runat="server" CssClass="eis_MainBox" Text="0" Width="100%" Font-Size="10pt"></asp:TextBox></td>
                                                                               </tr>
                                                                               <tr>
                                                                                   <td height="28" align="center" bgcolor="#EAEAEA">
                                                                                       실 &nbsp;적</td>
                                                                                   <td bgcolor="#EFEFEF">
                                                                                       <asp:TextBox ID="txtBrd2_2" runat="server" CssClass="eis_MainBox" Text="0" Width="100%" Font-Size="10pt"></asp:TextBox></td>
                                                                               </tr>
                                                                               <tr>
                                                                                   <td height="28" align="center" bgcolor="#EAEAEA">
                                                                                       전 &nbsp;년</td>
                                                                                   <td bgcolor="#EFEFEF" style="height: 28px">
                                                                                       <asp:TextBox ID="txtBrd2_3" runat="server" CssClass="eis_MainBox" Text="0" Width="100%" Font-Size="10pt"></asp:TextBox></td>
                                                                               </tr>
                                                                               <tr>
                                                                                   <td width="30%" height="28" align="center" bgcolor="#EAEAEA">
                                                                                       달성율</td>
                                                                                   <td bgcolor="#EFEFEF">
                                                                                       <asp:TextBox ID="txtBrd2_4" runat="server" CssClass="eis_MainBox" Text="0" Width="100%" Font-Size="10pt"></asp:TextBox></td>
                                                                               </tr>
                                                                               <tr>
                                                                                   <td height="28" align="center" bgcolor="#EAEAEA">
                                                                                       성장율</td>
                                                                                   <td bgcolor="#EFEFEF">
                                                                                       <asp:TextBox ID="txtBrd2_5" runat="server" CssClass="eis_MainBox" Text="0" Width="100%" Font-Size="10pt"></asp:TextBox></td>
                                                                               </tr>
                                                                           </table>
                                                                       </td>
                                                                   </tr>
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                    <tr>
                                                                        <td style="height: 17px">
                                                                            <img align="left" alt="" src="../images/title_ic01.gif" /><font color="#408bef"><strong>매출량 (<asp:Label ID="lbl03" runat="server" Text=""></asp:Label>)</strong></font></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                    <tr>
                                                                        <td style="height: 17px">
                                                                            <img align="left" alt="" src="../images/title_ic01.gif" /><font color="#408bef"><strong>손 익 (<asp:Label ID="lbl04" runat="server" Text=""></asp:Label>)</strong></font></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <DGWC:GaugeContainer id="GaugeContainer4" runat="server" backcolor="White" Height="130px" Width="420px" AutoLayout="False">
                                                                    <CircularGauges>
                                                                        <DGWC:CircularGauge Name="Default">
                                                                            ...
                                                                            <BackFrame BackColor="OrangeRed" BackGradientEndColor="50, 0, 0" BackGradientType="TopBottom" BorderColor="DarkGray" BorderWidth="1" FrameGradientType="None" FrameWidth="1" Shape="AutoShape" Style="edged" />
                                                                            <Location X="0" Y="0" />
                                                                        </DGWC:CircularGauge>
                                                                    </CircularGauges>
                                                                    <Labels>
