<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R010.aspx.cs" Inherits="eis_SEM_Mana_R010" %>
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
                    <tr> 
                        ...
                        <td class="box_td01">
                            ...
                            <asp:DropDownList ID="cboMCom" runat="server" Visible="true"  OnSelectedIndexChanged="cboMCom_SelectedIndexChanged" AutoPostBack="true" width="190px">
                            </asp:DropDownList>
                        </td>
                        <td align="center" bgcolor="A6C5D1"><strong><font color="#FFFFFF">입력</font></strong></td>
                        <td class="box_td01">
                            <asp:textBox ID="cboName"  runat="server" Visible="true"  width="85px">
                            </asp:textBox>
                        </td>
