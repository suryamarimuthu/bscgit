<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Empl_R005.aspx.cs" Inherits="eis_SEM_Empl_R005" %>
                ...
                <table width="800px" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
                    ...
                    <td align="center" bgcolor="A6C5D1"><strong><font color="#FFFFFF">년월</font></strong></td>
                        <td class="box_td01">
                            ...
                            <asp:DropDownList ID="ddlLocation3" runat="server" AppendDataBoundItems="True" EnableTheming="False">
                            </asp:DropDownList>
                            &nbsp;&nbsp;
