<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R003.aspx.cs" Inherits="eis_SEM_Mana_R003" %>
            ...
            <div>
                ...
                <table width="800px" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
                    <tr> 
                        ...
                        <td class="box_td01">
                            <ig:WebDateChooser ID="sDate" runat="server" AllowNull="true">
                            </ig:WebDateChooser>
                        </td>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>월별계획대비실적</strong></font></td>
