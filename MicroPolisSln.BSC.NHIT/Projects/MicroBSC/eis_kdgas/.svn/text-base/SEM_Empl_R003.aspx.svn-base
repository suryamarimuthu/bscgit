<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Empl_R003.aspx.cs" Inherits="eis_SEM_Empl_R003" %>
...
<script type="text/javascript">
            function mfChangeLocate(oMe, sLocate1, sLocate2)
            {
                try
                {
                    if (!oMe.options[0].selected)
                    {
                        document.all[sLocate1].options[0].selected = true;
                        document.all[sLocate2].options[0].selected = true;
                    }
                }
                catch(e){};
            }
...
<td valign="top" style="height:200" align="left">
    <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
            <tr>
                <td align="center" bgcolor="A6C5D1" width="10%"><strong><font color="#FFFFFF">년월</font></strong></td>
                <td class="box_td01">
            ...
            <td class="box_td01">
                <asp:DropDownList ID="ddlLocation1" runat="server" AppendDataBoundItems="True" EnableTheming="False">
                </asp:DropDownList>
                <asp:DropDownList ID="ddlLocation2" runat="server" AppendDataBoundItems="True" EnableTheming="False">
                </asp:DropDownList>
            </td>
            <td align="center" bgcolor="A6C5D1" width="10%"><strong><font color="#FFFFFF">구분</font></strong></td>
            <td class="box_td01">
                <asp:DropDownList ID="ddlStyle" runat="server" AppendDataBoundItems="True" EnableTheming="False">
                    <asp:ListItem Value="1">직위</asp:ListItem>
                    <asp:ListItem Value="2">호봉</asp:ListItem>
                    <asp:ListItem Value="3">근속년수</asp:ListItem>
                    <asp:ListItem Value="4">학력</asp:ListItem>
                    <asp:ListItem Value="5">연령</asp:ListItem>
                </asp:DropDownList>
            </td>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="800px" height="95%" >
    	<tr>
    	<td style="padding-left:0px;" height="300">
    	<table border=0 width=100%>
    	    <tr>
    	        <td>
    	            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><img alt="" src="../images/title_ic01.gif" align="left" /><font color="408BEF"><strong>백분율</strong></font></td>
                        </tr>
                    </table>
                    </td>
    	        <td>
    	            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>구성현황</strong></font></td>
                        </tr>
                    </table>
                </td>
    	    </tr>
    	        ...
    	        <td>
                    ...
                    <Legends>
                        <DCWC:Legend Alignment="Center" BackColor="White" BorderColor="26, 59, 105" Docking="Top"
                            LegendStyle="Row" Name="Default" ShadowOffset="2" Enabled="false">
                        </DCWC:Legend>
                    </Legends>
                    </DCWC:Chart>
    	        </td>
    		    		...
    		    		<td>
                            <ig:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="100%"
                                ...
                                <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                                                ...
                                                <RowStyleDefault BackColor="#FCFEFE" BorderColor="#D2D2D2" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign=Center>
                                                    <BorderDetails  ColorLeft="Window" ColorTop="Window" />
                                                    <Padding Left="3px" />
                                                </RowStyleDefault>
                                                <HeaderStyleDefault BackColor="#55A2B0" BorderStyle="Solid" HorizontalAlign="Center" BorderColor="#C7C7C7" ForeColor="White">
