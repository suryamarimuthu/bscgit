<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R040.aspx.cs" Inherits="eis_SEM_Mana_R040" %>
...
<html>
    ...
    <body style="margin:0 0 0 0 ; background-color:#FFFFFF">
      ...
      <table border="0" cellspacing="1" cellpadding="2" width="800px" style="height:100%" bgcolor="#FFFFFF">
        <tr>
            <td valign="top" style="height:40" align="left">
    		    	...
    		    	<tr>
    		    		<td>
                                <ig:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="800px"
                                        Width="400" oninitializelayout="UltraWebGrid1_InitializeLayout" OnInitializeRow="UltraWebGrid1_InitializeRow1" >
                                        <Bands>
