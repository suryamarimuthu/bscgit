<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R032.aspx.cs" Inherits="eis_SEM_Mana_R032" %>
            ...
            <div>
                ...
                <table width="800px" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF"  class="box_tt01">
                    <tr> 
                        ...
                        <td class="box_td01">
                             <asp:DropDownList ID="cboCom" runat="server" AppendDataBoundItems="True" EnableTheming="False" Visible="false">
                             </asp:DropDownList>
                        </td>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="동종사 매출량" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>매출량 현황 (종합)</strong></font></td>
