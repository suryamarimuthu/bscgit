<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R069.aspx.cs" Inherits="eis_SEM_Mana_R069" %>
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
                    <tr> 
                        ...
                        <td class="box_td01">
                            ...
                            <asp:DropDownList ID="cboDEPT" runat="server" AppendDataBoundItems="True" EnableTheming="False">
                            </asp:DropDownList>
                            <asp:DropDownList ID="cboTEAM" runat="server" AppendDataBoundItems="True" EnableTheming="False">
                            </asp:DropDownList>
                        </td>
                        <td align="center" bgcolor="A6C5D1"><strong><font color="#FFFFFF">비용구분</font></strong></td>
                        <td class="box_td01">
                            <asp:DropDownList ID="cboEXPS" runat="server" AppendDataBoundItems="True" EnableTheming="False">
                            </asp:DropDownList>
                        </td>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>예산집행 현황</strong></font></td>
    		    	        ...
    		    	        <tr>
    		    		        <td>
                                    <ig:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="135px"
                                        Width="100%" oninitializelayout="UltraWebGrid1_InitializeLayout"  OnInitializeRow="UltraWebGrid1_InitializeRow1" >
                                        <Bands>
                                   ...
                                   <%--<ig:UltraWebGrid ID="UltraWebGrid2" runat="server" Height="135px"
