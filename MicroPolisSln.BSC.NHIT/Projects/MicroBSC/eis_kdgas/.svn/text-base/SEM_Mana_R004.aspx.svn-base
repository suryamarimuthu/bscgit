<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R004.aspx.cs" Inherits="eis_SEM_Mana_R004" %>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>월별 공급량</strong></font></td>
                                          ...
                                          <DCWC:Chart ID="Chart1" runat="server" ImageUrl="~/TempImages/ChartPic_#SEQ(300,3)" Palette="Dundas" Width="800px" >
                                            <ChartAreas>
                                                <DCWC:ChartArea Name="Default" BorderColor="196, 196, 196"
                                                 ...
                                                 <Area3DStyle XAngle="50" YAngle="20" WallWidth="5" Enable3D="false" />
                                                </DCWC:ChartArea>
                                            </ChartAreas>
                                            <Legends>
