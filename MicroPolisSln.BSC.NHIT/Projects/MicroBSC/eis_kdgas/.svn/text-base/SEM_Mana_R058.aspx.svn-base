<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R058.aspx.cs" Inherits="eis_SEM_Mana_R058" %>
            ...
            <div>
                ...
                <!--- MAIN START --->
                 <table width="800px" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
                    <tr>
                    <td align="center" bgcolor="A6C5D1"><strong><font color="#FFFFFF">기준년월</font></strong></td>
                        <td class="box_td01">
	                        ...
	                        <table border=0 width=100%>
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>월별 처리건수</strong></font></td>
                                        </tr>
                                    </table>
	                                </td>
	                            </tr>
