<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R012.aspx.cs" Inherits="eis_SEM_Mana_R012" %>
	                    ...
	                    <td style="padding-left:5px;">
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="계획대비실적" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>계획대비실적</strong></font></td>
