<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R065P.aspx.cs" Inherits="eis_SEM_Mana_R065P" %>
	                        ...
	                        <table border="0" width="100%">
	                            ...
	                            <tr>
	                                <td width="100%" align="center">
                                          <DCWC:Chart ID="Chart1" runat="server" ImageUrl="~/TempImages/ChartPic_#SEQ(300,3)" Palette="Dundas" Width="300px" >
                                            <ChartAreas>
                                                <DCWC:ChartArea BackColor="White" BackGradientEndColor="White" BorderColor="196, 196, 196"
                                                    ...
                                                    <AxisX LabelsAutoFit="False" LineColor="196, 196, 196" Interval="1">
                                                     ...
                                                     <InnerPlotPosition Height="90" Width="97.33375" X="1.33312" Y="2.01094" Auto="true" />
                                                     <Position Height="83.15719" Width="94" X="3" Y="13.84281" />
                                                    <AxisY LineColor="196, 196, 196" LabelsAutoFit="false">
                                                        <LabelStyle Font="Tahoma, 10px" />
                                                        <MajorGrid LineColor="196, 196, 196" />
                                                    </AxisY>
                                                    <AxisY2 Enabled="True" LineStyle="Solid" LabelsAutoFit="false">
                                                        <LabelStyle Font="Tahoma, 10px" />
                                                    </AxisY2>
                                                </DCWC:ChartArea>
                                            </ChartAreas>
