<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_FIna_R012.aspx.cs" Inherits="eis_SEM_FIna_R012" %>
	                        ...
	                        <table border=0 width=100%>
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>영업이익</strong></font></td>
	                            ...
	                            <tr>
	                                <td width=100% colspan="2" style="padding-left:5px;">
