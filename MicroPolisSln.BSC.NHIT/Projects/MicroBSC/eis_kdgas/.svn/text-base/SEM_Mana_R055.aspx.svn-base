<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R055.aspx.cs" Inherits="eis_SEM_Mana_R055" %>
                ...
                <table width="800px" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF"  class="box_tt01">
                    <tr> 
                        ...
                        <td class="box_td01">
                             ...
                             <asp:DropDownList ID="cboGbnPQ" runat="server" AppendDataBoundItems="True" EnableTheming="False">
                             </asp:DropDownList>
                        </td>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="800px" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="계획 대비 증감" src="../images/title_ic01.gif" align="left" /><font color="408BEF"><strong>계획 대비 증감(<asp:Label ID="lblTitle" runat="server" Text="" />)</strong></font></td>
                                            <td align="right"><font color="408BEF"><strong>단 위 : 
                                                              <asp:Label ID="lblUnit" runat="server" Text=""></asp:Label></strong></font></td>
                                        </tr>
                                    </table>
	                                </td>
	                            </tr>
