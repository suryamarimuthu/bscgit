<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R065.aspx.cs" Inherits="eis_SEM_Mana_R065" %>
                ...
                <table width="800px" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
                    <tr> 
                        ...
                        <td colspan="2" align="right" class="box_td01">
                            ...
                            <asp:ImageButton ID="iBtnGraph" runat="server" Height="19" ImageUrl="~/images/btn/b_033.gif" OnClick="iBtnGraph_Click" />&nbsp;
                        </td>
                    </tr>
                </table>
	                        ...
	                        <table border="0" width="100%">
	                            ...
	                            <tr>
	                                <td width="100%" align="center">
                                     <ig:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="450px"
	                ...
	                <tr>
		                <td align="center">
		                  <table cellpadding="0"  cellspacing="0">
		                    <tr>
    	                       <td>
                                      <DCWC:Chart ID="Chart1" runat="server" ImageUrl="~/TempImages/ChartPic_#SEQ(300,3)" Palette="Dundas" Visible="False" >
                                            <ChartAreas>
