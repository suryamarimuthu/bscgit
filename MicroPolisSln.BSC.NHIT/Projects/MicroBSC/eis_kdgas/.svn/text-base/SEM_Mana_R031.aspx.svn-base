<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R031.aspx.cs" Inherits="eis_SEM_Mana_R031" %>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>공급량 계획대비실적</strong></font></td>
