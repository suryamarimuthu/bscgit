<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R070.aspx.cs" Inherits="eis_SEM_Mana_R070" %>
        ...
        <form id="form1" runat="server">
            <div>
                ...
                <table width="800px" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
                    <tr> 
                        <td width="15%" align="center" bgcolor="A6C5D1"><strong><font color="#FFFFFF">년/월/일</font></strong></td>
                        <td class="box_td01">
                            ...
                            <asp:DropDownList ID="cboDD" runat="server" AppendDataBoundItems="True" EnableTheming="False">
                            </asp:DropDownList>
                        </td>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>고객 현황</strong></font></td>
                                            <td align="right"><font color="408BEF"><strong>단 위 : 고객수</strong></font>&nbsp;&nbsp;</td>
                                        </tr>
                                    </table>
	                                </td>
	                            </tr>
