<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Fina_R002.aspx.cs" Inherits="eis_SEM_Fina_R002" %>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="요약 대차대조표 증감 추이" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>요약 대차대조표 증감 추이</strong></font></td>
