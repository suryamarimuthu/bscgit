...
public partial class eis_SEM_Fina_R027 : EISPageBase
{
    int type = 0;
    ...
    private void _initForm(bool blnGbn)
    {
        ...
        if (!blnGbn)
        {
            ...
            this.cboMM.Items.Add(new ListItem("1/4 분기", "1"));
            this.cboMM.Items.Add(new ListItem("2/4 분기", "2"));
            this.cboMM.Items.Add(new ListItem("3/4 분기", "3"));
            this.cboMM.Items.Add(new ListItem("4/4 분기", "4"));

            if (intMM > 0 && intMM < 4)
            {
                this.cboMM.SelectedValue = "1";
            }
            else if (intMM >= 4 && intMM < 7)
            {
                this.cboMM.SelectedValue = "2";
            }
            else if (intMM >= 7 && intMM < 10)
            {
                this.cboMM.SelectedValue = "3";
            }
            else
            {
                this.cboMM.SelectedValue = "4";
            }
            ...
            this.cboGubn.SelectedIndex = 1;

            this.cboGubn.Visible = false;
    ...
    private void _queryGrid(bool blnPostYn)
    {
        ...
        string strMM = "12";
        //switch (this.cboMM.SelectedValue)
        //{ 
        //    case "1":
        //        strMM = "3";
        //        break;
        ...
        OracleCommand objCmd = new OracleCommand("PKG_SEM_Fina_R004.PROC_Fina_R004_03", _connection);
        _connection.Open();
