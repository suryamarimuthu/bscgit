...
public partial class eis_SEM_Fina_R026 : EISPageBase                                                                          
{                                                                                                                             
     int type = 0;                                                                                                            
    ...
    {                                                                                                                         
        ...
        {                                                                                                                     
            ...
            this.cboOffi.Items.Add(new ListItem("전체", ""));                                                                 
            this.cboOffi.Items.Add(new ListItem("울산", "01"));                                                        
            this.cboOffi.Items.Add(new ListItem("양산", "02"));                                                        
            cboOffi.SelectedIndex = 0;                                                                                        
    ...
    {                                                                                                                         
        ...
        OracleCommand objCmdGrid = new OracleCommand("PKG_SEM_Fina_R026.PROC_Fina_R026_01", _connection);                     
        _connection.Open();                                                                                                   
        ...
        arrOpmGrid[1] = new OracleParameter("i_OFFI", OracleType.VarChar, 12);                                                
        arrOpmGrid[1].Value = cboOffi.SelectedValue;                                                                          
        arrOpmGrid[2] = new OracleParameter("O_Fina_R026", OracleType.Cursor);                                                
