...
public partial class eis_SEM_Mana_R000_02 : EISPageBase
{
    int type = 0;
    ...
    private void _initForm(bool blnGbn)
    {
        ...
        if (!blnGbn)
        {
            ...
            this.cboGbn.SelectedIndex = 1;

            txtBrd1_1.Style.Add(HtmlTextWriterStyle.TextAlign, "right");
            txtBrd1_2.Style.Add(HtmlTextWriterStyle.TextAlign, "right");
            txtBrd1_3.Style.Add(HtmlTextWriterStyle.TextAlign, "right");
            txtBrd1_4.Style.Add(HtmlTextWriterStyle.TextAlign, "right");
            txtBrd1_5.Style.Add(HtmlTextWriterStyle.TextAlign, "right");

            txtBrd2_1.Style.Add(HtmlTextWriterStyle.TextAlign, "right");
            txtBrd2_2.Style.Add(HtmlTextWriterStyle.TextAlign, "right");
            txtBrd2_3.Style.Add(HtmlTextWriterStyle.TextAlign, "right");
            txtBrd2_4.Style.Add(HtmlTextWriterStyle.TextAlign, "right");
            txtBrd2_5.Style.Add(HtmlTextWriterStyle.TextAlign, "right");

            txtBrd1_1.Style.Add(HtmlTextWriterStyle.BackgroundColor, "#EFEFEF");
            txtBrd1_2.Style.Add(HtmlTextWriterStyle.BackgroundColor, "#EFEFEF");
            txtBrd1_3.Style.Add(HtmlTextWriterStyle.BackgroundColor, "#EFEFEF");
            txtBrd1_4.Style.Add(HtmlTextWriterStyle.BackgroundColor, "#EFEFEF");
            txtBrd1_5.Style.Add(HtmlTextWriterStyle.BackgroundColor, "#EFEFEF");

            txtBrd2_1.Style.Add(HtmlTextWriterStyle.BackgroundColor, "#EFEFEF");
            txtBrd2_2.Style.Add(HtmlTextWriterStyle.BackgroundColor, "#EFEFEF");
            txtBrd2_3.Style.Add(HtmlTextWriterStyle.BackgroundColor, "#EFEFEF");
            txtBrd2_4.Style.Add(HtmlTextWriterStyle.BackgroundColor, "#EFEFEF");
            txtBrd2_5.Style.Add(HtmlTextWriterStyle.BackgroundColor, "#EFEFEF");

            txtBrd1_1.Style.Add(HtmlTextWriterStyle.FontSize, "9pt");
            txtBrd1_2.Style.Add(HtmlTextWriterStyle.FontSize, "9pt");
            txtBrd1_3.Style.Add(HtmlTextWriterStyle.FontSize, "9pt");
            txtBrd1_4.Style.Add(HtmlTextWriterStyle.FontSize, "9pt");
            txtBrd1_5.Style.Add(HtmlTextWriterStyle.FontSize, "9pt");

            txtBrd2_1.Style.Add(HtmlTextWriterStyle.FontSize, "9pt");
            txtBrd2_2.Style.Add(HtmlTextWriterStyle.FontSize, "9pt");
            txtBrd2_3.Style.Add(HtmlTextWriterStyle.FontSize, "9pt");
            txtBrd2_4.Style.Add(HtmlTextWriterStyle.FontSize, "9pt");
            txtBrd2_5.Style.Add(HtmlTextWriterStyle.FontSize, "9pt");

            txtBrd1_1.Style.Add(HtmlTextWriterStyle.PaddingRight, "5px");
            txtBrd1_2.Style.Add(HtmlTextWriterStyle.PaddingRight, "5px");
            txtBrd1_3.Style.Add(HtmlTextWriterStyle.PaddingRight, "5px");
            txtBrd1_4.Style.Add(HtmlTextWriterStyle.PaddingRight, "5px");
            txtBrd1_5.Style.Add(HtmlTextWriterStyle.PaddingRight, "5px");

            txtBrd2_1.Style.Add(HtmlTextWriterStyle.PaddingRight, "5px");
            txtBrd2_2.Style.Add(HtmlTextWriterStyle.PaddingRight, "5px");
            txtBrd2_3.Style.Add(HtmlTextWriterStyle.PaddingRight, "5px");
            txtBrd2_4.Style.Add(HtmlTextWriterStyle.PaddingRight, "5px");
            txtBrd2_5.Style.Add(HtmlTextWriterStyle.PaddingRight, "5px");
        }
    }
    ...
    private void _queryGrid()
    {
        ...
        arrOpmBrd1[0] = new OracleParameter("i_YYMM", OracleType.VarChar, 20);
        arrOpmBrd1[0].Direction = ParameterDirection.Output;
        ...
        lbl01.Text = objCmdBoard1.Parameters["i_YYMM"].Value.ToString();

        //================================================================== Dash Board 2
        OracleParameter[] arrOpmBrd2 = new OracleParameter[3];

        arrOpmBrd2[0] = new OracleParameter("i_YYMM", OracleType.VarChar, 20);
        arrOpmBrd2[0].Direction = ParameterDirection.Output;
        ...
        lbl02.Text = objCmdBoard2.Parameters["i_YYMM"].Value.ToString();

        //================================================================== Dash Board 3
        //OracleParameter[] arrOpmBrd3 = new OracleParameter[3];

        //arrOpmBrd3[0] = new OracleParameter("i_YYMM", OracleType.VarChar, 20);
        //arrOpmBrd3[0].Direction = ParameterDirection.Output;
        ...
        //daBoard3.Fill(dsBoard3);
        //this.setDashBoard3(dsBoard3);

        //lbl03.Text = objCmdBoard3.Parameters["i_YYMM"].Value.ToString();

        //================================================================== Dash Board 4
        //OracleParameter[] arrOpmBrd4 = new OracleParameter[3];

        //arrOpmBrd4[0] = new OracleParameter("i_YYMM", OracleType.VarChar, 20);
        //arrOpmBrd4[0].Direction = ParameterDirection.Output;
        ...
        //lbl04.Text = objCmdBoard4.Parameters["i_YYMM"].Value.ToString();
    ...
    private void setDashBoard1(DataSet iDsSet)
    {
        ...
        if (intRow > 0)
        {
            ...
            string sd4 = double.Parse(iDsSet.Tables[0].Rows[0][3].ToString()).ToString("#,##0.#0");
            string sd5 = double.Parse(iDsSet.Tables[0].Rows[0][4].ToString()).ToString("#,##0.#0");
            decimal id4 = decimal.Parse(sd4);
            decimal id5 = decimal.Parse(sd5)-100;
            if (id4 >= 100)
            {
                txtBrd1_4.ControlStyle.ForeColor = Color.Blue;
                txtBrd1_4.Text = double.Parse(iDsSet.Tables[0].Rows[0][3].ToString()).ToString("#,##0.#0");
                
            }
            else
            {
                txtBrd1_4.ControlStyle.ForeColor = Color.Red;
                txtBrd1_4.Text = double.Parse(iDsSet.Tables[0].Rows[0][3].ToString()).ToString("#,##0.#0");

            }
            if (id5 >= 0)
            {
                txtBrd1_5.ControlStyle.ForeColor = Color.Blue;
            }
            else
            {
                txtBrd1_5.ControlStyle.ForeColor = Color.Red;
            }
            txtBrd1_5.Text = (id5 == 0) ? Convert.ToString(0) : id5.ToString("#,##0.#0");

            double dblMax = 0.00;
                   dblMax = Math.Round(double.Parse(iDsSet.Tables[0].Rows[0][3].ToString()),0);
                   GaugeContainer1.CircularGauges["Default"].Scales[0].Minimum = 80;
                   GaugeContainer1.CircularGauges["Default"].Scales[0].Maximum = (dblMax >= 100) ? dblMax : 100 ;
            /*
    ...
    private void setDashBoard2(DataSet iDsSet)
    {
        ...
        if (intRow > 0)
        {
            ...
            if (id4 >= 100)
            {
                txtBrd2_4.ControlStyle.ForeColor = Color.Blue;
                txtBrd2_4.Text = double.Parse(iDsSet.Tables[0].Rows[0][3].ToString()).ToString("#,##0.#0");

            }
            else
            {
                txtBrd2_4.ControlStyle.ForeColor = Color.Red;
                txtBrd2_4.Text = double.Parse(iDsSet.Tables[0].Rows[0][3].ToString()).ToString("#,##0.#0");
            ...
            if (id5 >= 0)
            {
                txtBrd2_5.ControlStyle.ForeColor = Color.Blue;
            }
            else
            {
                txtBrd2_5.ControlStyle.ForeColor = Color.Red;
            }
            txtBrd2_5.Text = (id5 == 0) ? Convert.ToString(0) : id5.ToString("#,##0.#0");
            
            GaugeContainer2.CircularGauges["Default"].Pointers["Default"].Value = Convert.ToDouble(iDsSet.Tables[0].Rows[0][3].ToString());

            double dblMax = 0.00;
            dblMax = Math.Round(double.Parse(iDsSet.Tables[0].Rows[0][3].ToString()), 0);
            GaugeContainer2.CircularGauges["Default"].Scales[0].Minimum = 80;
            GaugeContainer2.CircularGauges["Default"].Scales[0].Maximum = (dblMax >= 100) ? dblMax : 100;
        }
        else
        {
            txtBrd2_1.Text = "0";
    ...
    private void setDashBoard3(DataSet iDsSet)
    {
        ...
        if (intRow > 0)
        {
            ...
            string sd5 = double.Parse(iDsSet.Tables[0].Rows[0][4].ToString()).ToString("#,##0.#0");
            decimal id4 = decimal.Parse(sd4);
            decimal id5 = decimal.Parse(sd5);
            if (id4 >= 100)
            {
                txtBrd3_4.ControlStyle.ForeColor = Color.Blue;
                txtBrd3_4.Text = double.Parse(iDsSet.Tables[0].Rows[0][3].ToString()).ToString("#,##0.#0");

            }
            else
            {
                txtBrd3_4.ControlStyle.ForeColor = Color.Red;
                txtBrd3_4.Text = double.Parse(iDsSet.Tables[0].Rows[0][3].ToString()).ToString("#,##0.#0");

            }
            if (id5 + 100 >= 100)
            {
                txtBrd3_5.ControlStyle.ForeColor = Color.Blue;
                txtBrd3_5.Text = double.Parse(iDsSet.Tables[0].Rows[0][4].ToString()).ToString("#,##0.#0");

            }
            else
            {
                txtBrd3_5.ControlStyle.ForeColor = Color.Red;
                txtBrd3_5.Text = double.Parse(iDsSet.Tables[0].Rows[0][4].ToString()).ToString("#,##0.#0");
            ...
            double dblMax = 0.00;
            dblMax = Math.Round(double.Parse(iDsSet.Tables[0].Rows[0][3].ToString()), 0);
            GaugeContainer3.CircularGauges["Default"].Scales[0].Maximum = (dblMax >= 100) ? dblMax : 100;
        }
        else
        {
            txtBrd3_1.Text = "0";
    ...
    private void setDashBoard4(DataSet iDsSet)
    {
        ...
        if (intRow > 0)
        {
            ...
            if (id4 >= 100)
            {
                txtBrd4_4.ControlStyle.ForeColor = Color.Blue;
                txtBrd4_4.Text = double.Parse(iDsSet.Tables[0].Rows[0][3].ToString()).ToString("#,##0.#0");

            }
            else
            {
                txtBrd4_4.ControlStyle.ForeColor = Color.Red;
                txtBrd4_4.Text = double.Parse(iDsSet.Tables[0].Rows[0][3].ToString()).ToString("#,##0.#0");

            }
            if (id5 + 100 >= 100)
            {
                txtBrd4_5.ControlStyle.ForeColor = Color.Blue;
                txtBrd4_5.Text = double.Parse(iDsSet.Tables[0].Rows[0][4].ToString()).ToString("#,##0.#0");

            }
            else
            {
                txtBrd4_5.ControlStyle.ForeColor = Color.Red;
                txtBrd4_5.Text = double.Parse(iDsSet.Tables[0].Rows[0][4].ToString()).ToString("#,##0.#0");
            ...
            double dblMax = 0.00;
            dblMax = Math.Round(double.Parse(iDsSet.Tables[0].Rows[0][3].ToString()), 0);
            GaugeContainer4.CircularGauges["Default"].Scales[0].Maximum = (dblMax >= 100) ? dblMax : 100;
        }
        else
        {
            txtBrd4_1.Text = "0";
    ...
    protected void GaugeContainer1_Click(object sender, ImageClickEventArgs e)
    {
        Response.Redirect("SEM_Mana_R001.aspx");
    }
}
