<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R020.aspx.cs" Inherits="eis_SEM_Mana_R020" %>
                                            ...
                                            <ig:UltraGridBand>
                                                ...
                                                <Columns>
                                                    ...
                                                    <ig:UltraGridColumn BaseColumnName="ACHV_RATE" EditorControlID="" FooterText=""
                                                        Format="#,##0.0" HeaderText="달성률(%)" Key="ACHV_RATE" NullText="0" Width="60px">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <Header Caption="달성률(%)">
