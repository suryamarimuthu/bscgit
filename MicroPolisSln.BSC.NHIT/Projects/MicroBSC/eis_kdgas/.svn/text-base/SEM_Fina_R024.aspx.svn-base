<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Fina_R024.aspx.cs" Inherits="eis_SEM_Fina_R024" %>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="손익계산서 상세" src="../images/title_ic01.gif" align="left" /><font color="408BEF"><strong>손익계산서 상세</strong></font></td>
