...
public partial class eis_SEM_Fina_R002 : EISPageBase
{
    int type = 0;
    ...
    {
        string sqlAcct = @"
               SELECT DISTINCT SEM_ACCOUNT1_CODE as ACCT_CD, SEM_ACCOUNT1_DESC as ACCT_NM 
                 FROM SEM_FINANCIAL_CODE_MASTER 
                WHERE SEM_FINANCIAL_CODE_MASTER.SEM_FINANCIAL_CODE = 'BS'";
    ...
    private void _queryGrid(bool blnPostYn)
    {
        ...
        OracleConnection _connection = new OracleConnection();
        _connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["MainDB_Oracle"].ConnectionString;
        OracleCommand objCmd = new OracleCommand("PKG_SEM_Fina_R002.PROC_Fina_R002_01", _connection);
        _connection.Open();
        ...
        arrOpm[2] = new OracleParameter("O_Fina_R002", OracleType.Cursor);
