...
public partial class eis_SEM_Mana_R015 : System.Web.UI.Page
{
    int type = 0;
        ...
        query = @"SELECT SGBUN_CD, MAX(SGBUN_NM) SGBUN_NM,
          ...
          FROM (
               SELECT A.SGBUN_CD as SGBUN_CD, MAX(A.SGBUN_NM) as SGBUN_NM, MAX(A.YY) as YY, MAX(A.MM) as MM,
			          DECODE(MAX(A.MM),'01',SUM(A.S_PLAN)/1000,0) as PLAN_01,
			          DECODE(MAX(A.MM),'02',SUM(A.S_PLAN)/1000,0) as PLAN_02,
			          DECODE(MAX(A.MM),'03',SUM(A.S_PLAN)/1000,0) as PLAN_03,
			          DECODE(MAX(A.MM),'04',SUM(A.S_PLAN)/1000,0) as PLAN_04,
			          DECODE(MAX(A.MM),'05',SUM(A.S_PLAN)/1000,0) as PLAN_05,
			          DECODE(MAX(A.MM),'06',SUM(A.S_PLAN)/1000,0) as PLAN_06,
			          DECODE(MAX(A.MM),'07',SUM(A.S_PLAN)/1000,0) as PLAN_07,
			          DECODE(MAX(A.MM),'08',SUM(A.S_PLAN)/1000,0) as PLAN_08,
			          DECODE(MAX(A.MM),'09',SUM(A.S_PLAN)/1000,0) as PLAN_09,
			          DECODE(MAX(A.MM),'10',SUM(A.S_PLAN)/1000,0) as PLAN_10,
			          DECODE(MAX(A.MM),'11',SUM(A.S_PLAN)/1000,0) as PLAN_11,
			          DECODE(MAX(A.MM),'12',SUM(A.S_PLAN)/1000,0) as PLAN_12,
			          DECODE(MAX(A.MM),'01',SUM(A.S_RSLT)/1000,0) as ACTL_01,
			          DECODE(MAX(A.MM),'02',SUM(A.S_RSLT)/1000,0) as ACTL_02,
			          DECODE(MAX(A.MM),'03',SUM(A.S_RSLT)/1000,0) as ACTL_03,
			          DECODE(MAX(A.MM),'04',SUM(A.S_RSLT)/1000,0) as ACTL_04,
			          DECODE(MAX(A.MM),'05',SUM(A.S_RSLT)/1000,0) as ACTL_05,
			          DECODE(MAX(A.MM),'06',SUM(A.S_RSLT)/1000,0) as ACTL_06,
			          DECODE(MAX(A.MM),'07',SUM(A.S_RSLT)/1000,0) as ACTL_07,
			          DECODE(MAX(A.MM),'08',SUM(A.S_RSLT)/1000,0) as ACTL_08,
			          DECODE(MAX(A.MM),'09',SUM(A.S_RSLT)/1000,0) as ACTL_09,
			          DECODE(MAX(A.MM),'10',SUM(A.S_RSLT)/1000,0) as ACTL_10,
			          DECODE(MAX(A.MM),'11',SUM(A.S_RSLT)/1000,0) as ACTL_11,
			          DECODE(MAX(A.MM),'12',SUM(A.S_RSLT)/1000,0) as ACTL_12,
			          ...
			          DECODE(MAX(A.MM),'01',ROUND(DECODE(NVL(SUM(B.S_RSLT),0),0,0,(SUM(A.S_RSLT)/SUM(B.S_RSLT))*100)),2,0) as GROW_RATE_01,
			          DECODE(MAX(A.MM),'02',ROUND(DECODE(NVL(SUM(B.S_RSLT),0),0,0,(SUM(A.S_RSLT)/SUM(B.S_RSLT))*100)),2,0) as GROW_RATE_02,
			          DECODE(MAX(A.MM),'03',ROUND(DECODE(NVL(SUM(B.S_RSLT),0),0,0,(SUM(A.S_RSLT)/SUM(B.S_RSLT))*100)),2,0) as GROW_RATE_03,
			          DECODE(MAX(A.MM),'04',ROUND(DECODE(NVL(SUM(B.S_RSLT),0),0,0,(SUM(A.S_RSLT)/SUM(B.S_RSLT))*100)),2,0) as GROW_RATE_04,
			          DECODE(MAX(A.MM),'05',ROUND(DECODE(NVL(SUM(B.S_RSLT),0),0,0,(SUM(A.S_RSLT)/SUM(B.S_RSLT))*100)),2,0) as GROW_RATE_05,
			          DECODE(MAX(A.MM),'06',ROUND(DECODE(NVL(SUM(B.S_RSLT),0),0,0,(SUM(A.S_RSLT)/SUM(B.S_RSLT))*100)),2,0) as GROW_RATE_06,
			          DECODE(MAX(A.MM),'07',ROUND(DECODE(NVL(SUM(B.S_RSLT),0),0,0,(SUM(A.S_RSLT)/SUM(B.S_RSLT))*100)),2,0) as GROW_RATE_07,
			          DECODE(MAX(A.MM),'08',ROUND(DECODE(NVL(SUM(B.S_RSLT),0),0,0,(SUM(A.S_RSLT)/SUM(B.S_RSLT))*100)),2,0) as GROW_RATE_08,
			          DECODE(MAX(A.MM),'09',ROUND(DECODE(NVL(SUM(B.S_RSLT),0),0,0,(SUM(A.S_RSLT)/SUM(B.S_RSLT))*100)),2,0) as GROW_RATE_09,
			          DECODE(MAX(A.MM),'10',ROUND(DECODE(NVL(SUM(B.S_RSLT),0),0,0,(SUM(A.S_RSLT)/SUM(B.S_RSLT))*100)),2,0) as GROW_RATE_10,
			          DECODE(MAX(A.MM),'11',ROUND(DECODE(NVL(SUM(B.S_RSLT),0),0,0,(SUM(A.S_RSLT)/SUM(B.S_RSLT))*100)),2,0) as GROW_RATE_11,
			          DECODE(MAX(A.MM),'12',ROUND(DECODE(NVL(SUM(B.S_RSLT),0),0,0,(SUM(A.S_RSLT)/SUM(B.S_RSLT))*100)),2,0) as GROW_RATE_12
                 FROM (
