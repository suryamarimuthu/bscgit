...
public partial class eis_SEM_Mana_R025 : EISPageBase
{
    int type = 0;
    ...
    private void _queryChart()
    {
        ...
        OracleCommand objCmdGrph = new OracleCommand("PKG_SEM_Mana_R025.PROC_Mana_R025_01", _connection);
        _connection.Open();
        ...
        arrOpmGrph[3] = new OracleParameter("O_Mana_R025", OracleType.Cursor);
    ...
    private void _queryGrid()
    {
        ...
        OracleConnection _connection = new OracleConnection();
        _connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["MainDB_Oracle"].ConnectionString;
        OracleCommand objCmdGrph = new OracleCommand("PKG_SEM_Mana_R025.PROC_Mana_R025_02", _connection);
        _connection.Open();
