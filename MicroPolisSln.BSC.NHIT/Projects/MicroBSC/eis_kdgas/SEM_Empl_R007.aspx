<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Empl_R007.aspx.cs" Inherits="eis_SEM_Empl_R007" %>
...
<table border="0" cellspacing="1" cellpadding="2" width="800px" style="height:100%" bgcolor="#FFFFFF">
    <tr>
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
            ...
            <td align="center" bgcolor="A6C5D1" width="10%"><strong><font color="#FFFFFF">조직구분</font></strong></td>
            <td class="box_td01">
                &nbsp;<asp:RadioButtonList ID="rBtnType" runat="server"
                    RepeatDirection="Horizontal" RepeatLayout="Flow">
                    <asp:ListItem Selected="True" Value="1">부문별</asp:ListItem>
                    <asp:ListItem Value="2">팀별</asp:ListItem>
                </asp:RadioButtonList></td>
            <td align="center" bgcolor="A6C5D1" width="10%"><strong><font color="#FFFFFF">기간구분</font></strong></td>
            <td class="box_td01">
                <asp:DropDownList ID="ddlTerm" runat="server" AppendDataBoundItems="True" EnableTheming="False">
                </asp:DropDownList>
            </td>
    	...
    	<table border=0 width=100%>
    	    <tr>
    	        <td>
    	            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>조직별 평균 이수학점</strong></font></td>
    	    ...
    	    <tr>
    	        <td>
                    ...
                    <Legends>
                        <DCWC:Legend Alignment="Center" BackColor="White" BorderColor="26, 59, 105" Docking="Top" LegendStyle="Row" Name="Default" ShadowOffset="2">
                        </DCWC:Legend>
                    </Legends>
                    </DCWC:Chart>        
    	        </td>
