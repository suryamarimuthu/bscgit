<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R007.aspx.cs" Inherits="eis_SEM_Mana_R007" %>
        ...
        <tr>
            <td valign="top" style="height:200" align="left">
                <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF"  class="box_tt01">
                    <tr> 
                        <td align="center" bgcolor="A6C5D1"><strong><font color="#FFFFFF">시간</font></strong></td>
                        <td class="box_td01">
	                       ...
	                       <%-- <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="정압기별 압력현황" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>정압기별 압력현황</strong></font></td>
    		    		...
    		    		<td>
                            <ig:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="135px"
                                ...
                                <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                                    ...
                                    <HeaderStyleDefault BackColor="#55A2B0" verticalalign="Middle" font-bold="True" BorderStyle="Solid" HorizontalAlign="Center" BorderColor="#C7C7C7"
                                         ForeColor="White">
