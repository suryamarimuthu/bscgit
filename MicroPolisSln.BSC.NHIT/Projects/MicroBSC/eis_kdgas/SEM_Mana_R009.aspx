<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R009.aspx.cs" Inherits="eis_SEM_Mana_R009" %>
            ...
            <div>
                ...
                <table width="800px" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
                    <tr> 
                        ...
                        <td class="box_td01">
                            <asp:DropDownList ID="cboTCom" runat="server" Visible="true"  >
                            </asp:DropDownList>
                            <asp:DropDownList ID="cboGbnNew" runat="server" Visible="true" OnSelectedIndexChanged="cboTCom_SelectedIndexChanged" AutoPostBack="true" >
                            </asp:DropDownList>
                            <asp:DropDownList ID="cboMCom" runat="server" Visible="true" OnSelectedIndexChanged="cboMCom_SelectedIndexChanged" AutoPostBack="true" width="100px">
                            </asp:DropDownList>
                            
                        </td>
                        <td align="center" bgcolor="A6C5D1"><strong><font color="#FFFFFF">입력</font></strong></td>
                        <td class="box_td01">
                           <asp:textBox ID="cboName" runat="server" Visible="true"  width="85px" BorderWidth="0">
                            </asp:textBox>
                        </td>       
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>월별매출량</strong></font></td>
                                            ...
                                            <ChartAreas>
                                                <DCWC:ChartArea BackColor="White" BackGradientEndColor="White" BorderColor="196, 196, 196"
                                                    ...
                                                    <AxisX LabelsAutoFit="False" LineColor="196, 196, 196" Interval="1">
                                                     ...
                                                     <Area3DStyle WallWidth="3" YAngle="20" />
