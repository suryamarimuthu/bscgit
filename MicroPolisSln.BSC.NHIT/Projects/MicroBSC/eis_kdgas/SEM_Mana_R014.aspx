<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R014.aspx.cs" Inherits="eis_SEM_Mana_R014" %>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="용도별 계획대비실적" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>용도별 계획대비실적</strong></font></td>
                                        </tr>
                                    </table>
	                                </td>
	                                <td align="center">
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="용도별 전년대비실적" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>용도별 전년대비실적</strong></font></td>
                                            ...
                                            <ig:UltraGridBand>
                                                ...
                                                <Columns>
                                                    <ig:UltraGridColumn BaseColumnName="SGBUN_NM" EditorControlID="" FooterText="" Format=""
                                                        HeaderText="구분" Key="SGBUN_NM" Width="160px">
                                                    ...
                                                    <ig:UltraGridColumn BaseColumnName="L_RSLT" EditorControlID="" FooterText="" Format="###,###,0"
                                                        HeaderText="전년동기" Key="L_RSLT" NullText="0" Width="100px">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                    ...
                                                    <ig:UltraGridColumn BaseColumnName="S_DIFF" EditorControlID="" FooterText="" Format="###,###,0"
                                                        HeaderText="차이" Key="S_DIFF" NullText="0" Width="100px">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <Header Caption="차이">
                                                    ...
                                                    <ig:UltraGridColumn BaseColumnName="ACHV_RATE" EditorControlID="" FooterText=""
                                                        Format="#,##0.0" HeaderText="달성율(%)" Key="ACHV_RATE" NullText="0" Width="65px">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <Header Caption="달성율(%)">
                                                    ...
                                                    <ig:UltraGridColumn BaseColumnName="S_ADD" EditorControlID="" FooterText="" Format="###,###,0"
                                                        HeaderText="차이" Key="S_ADD" NullText="0" Width="100px">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <Header Caption="차이">
                                                    ...
                                                    <ig:UltraGridColumn BaseColumnName="GROW_RATE" EditorControlID="" FooterText=""
                                                        Format="#,##0.0" HeaderText="증가율(%)" Key="GROW_RATE" NullText="0" Width="65px">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <Header Caption="증가율(%)">
