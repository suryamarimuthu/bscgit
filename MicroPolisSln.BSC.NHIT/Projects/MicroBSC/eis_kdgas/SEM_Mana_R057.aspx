<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R057.aspx.cs" Inherits="eis_SEM_Mana_R057" %>
            ...
            <div>
                ...
                <table width="800px" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF"  class="box_tt01">
                    <tr> 
                        ...
                        <td class="box_td01"><ig:WebDateChooser ID="sDate" runat="server"></ig:WebDateChooser>
                        </td>
                        <td width="15%" align="center" bgcolor="A6C5D1"><strong><font color="#FFFFFF">사업장</font></strong></td>
                        <td class="box_td01">
                          <asp:DropDownList ID="cboComCd" runat="server" Visible="true"></asp:DropDownList>
                        </td>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="일자별 재고건수" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>일자별 재고건수</strong></font></td>
                                    ...
                                    <ig:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="800px"
                                        ...
                                        <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                                            ...
                                            <FrameStyle BackColor="Window" BorderColor="#E9EBEB" BorderStyle="Solid"
                                                BorderWidth="3px" Font-Names="Microsoft Sans Serif" Font-Size="8.25pt" Height="150px" Width="100%">
                                            </FrameStyle>
                                            <Pager>
