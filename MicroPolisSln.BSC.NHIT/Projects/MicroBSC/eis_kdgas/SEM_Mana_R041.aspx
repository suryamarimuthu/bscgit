<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R041.aspx.cs" Inherits="eis_SEM_Mana_R041" %>
...
<html>
    <head id="Head1" runat="server">
        <title>달성/성장율별 수요개발 현황_상세</title>
    ...
    <div>
        ...
        <table width="800px" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>수요개발현황(상세)</strong></font>&nbsp;&nbsp;</td>
    		    	...
    		    	<tr>
    		    		<td width=50% valign="top" align=center>
                            <ig:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="135px"
                                Width="100%" OnInitializeRow = "UltraWebGrid1_InitializeRow1" oninitializelayout="UltraWebGrid1_InitializeLayout">
                                <Bands>
