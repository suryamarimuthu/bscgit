<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R037.aspx.cs" Inherits="eis_SEM_Mana_R037" %>
...
<html>
    ...
    <body style="margin:0 0 0 0 ; background-color:#FFFFFF">
      ...
      <table border="0" cellspacing="1" cellpadding="2" width="800px" style="height:100%" bgcolor="#FFFFFF">
        <tr>
            <td valign="top" style="height:300" align="left">
                <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="box_tt01">
                    ...
                    <td align="center" bgcolor="A6C5D1"><strong><font color="#FFFFFF">년월</font></strong></td>
                        <td class="box_td01">
                            <asp:DropDownList ID="ddlYearS" runat="server" AppendDataBoundItems="True" EnableTheming="False">
                            </asp:DropDownList>
                            <asp:DropDownList ID="ddlMonthS" runat="server">
                            </asp:DropDownList> ~ 
                            <asp:DropDownList ID="ddlYearE" runat="server" AppendDataBoundItems="True" EnableTheming="False">
                            </asp:DropDownList>
                        ...
                        <td class="box_td01">
                            <asp:DropDownList ID="ddlGubun" runat="server">
                            </asp:DropDownList>
                        </td>
	            ...
	            <table width="800px" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>LNG 가격경쟁력 변동추이</strong></font></td>
