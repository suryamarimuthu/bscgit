<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R051.aspx.cs" Inherits="eis_SEM_Mana_R051" %>
...
<!--- MAIN START --->
    ...
    <tr>
    <td align="center" bgcolor="A6C5D1" width="12%"><strong><font color="#FFFFFF">년월</font></strong></td>
        <td class="box_td01">
    	...
    	<table border=0 width=100%>
    	    <tr>
    	        ...
    	        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong> 유형별 만족도</strong></font></td>
    	        ...
    	        <td>
                    ...
                    <ChartAreas>
                        ...
                        <AxisY linecolor="196, 196, 196" LabelsAutoFit="False">
                            ...
                            <Area3DStyle Enable3D="True" XAngle="15" YAngle="10" WallWidth="5" />
                        </DCWC:ChartArea>
                    </ChartAreas>
                    <Legends>
