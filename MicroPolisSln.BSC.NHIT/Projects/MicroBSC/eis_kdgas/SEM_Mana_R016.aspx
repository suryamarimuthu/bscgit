<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R016.aspx.cs" Inherits="eis_SEM_Mana_R016" %>
            ...
            <div>
                ...
                <table width="800px" border="0" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF"  class="box_tt01">
                    <tr> 
                        ...
                        <td class="box_td01">
                          <asp:DropDownList ID="cboCom" runat="server" Visible="true"></asp:DropDownList>
                        </td>
                        <td align="center" bgcolor="A6C5D1"><strong><font color="#FFFFFF">기 간</font></strong></td>
                        <td class="box_td01">
                          <asp:DropDownList ID="cboTerm" runat="server" Visible="true"></asp:DropDownList>
                        </td>
                        <td align="center" bgcolor="A6C5D1"><strong><font color="#FFFFFF">용 도</font></strong></td>
                        <td class="box_td01">
                          <asp:DropDownList ID="cboType" runat="server" Visible="true"></asp:DropDownList>
                        </td>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="고객단위당 매출량" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>고객단위당 매출량</strong></font></td>
                                            <td align="right"><font color="408BEF"><strong>단위 : ㎥</strong></font></td>
                                        </tr>
                                    </table>
	                                </td>
	                            </tr>
                                        ...
                                        <DCWC:Chart ID="Chart1" runat="server" ImageUrl="~/TempImages/ChartPic_#SEQ(300,3)" Palette="Dundas" Width="800px" >
                                            <ChartAreas>
                                                <DCWC:ChartArea Name="Default" BorderColor="196, 196, 196"
                                                    ...
                                                    <Area3DStyle Enable3D="false" XAngle="50" YAngle="20" WallWidth="5" />
                                                </DCWC:ChartArea>
                                            </ChartAreas>
                                            <Legends>
                                    ...
                                    <ig:UltraWebGrid ID="UltraWebGrid1" runat="server" Height="800px"
                                        ...
                                        <DisplayLayout AllowColSizingDefault="Free" AllowColumnMovingDefault="OnServer" AllowDeleteDefault="Yes"
                                            ...
                                            <FrameStyle BackColor="Window" BorderColor="#E9EBEB" BorderStyle="Solid"
                                                BorderWidth="3px" Font-Names="Microsoft Sans Serif" Font-Size="8.25pt" Height="100px" Width="100%">
                                            </FrameStyle>
                                            <Pager>
