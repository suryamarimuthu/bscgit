<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEM_Mana_R025.aspx.cs" Inherits="eis_SEM_Mana_R025" %>
	                        ...
	                        <table border="0" width="100%">
	                            <tr>
	                                ...
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="" src="../images/title_ic01.gif" align="left" /><font color="408BEF"><strong>CNG 년도별 매출액 추이</strong></font></td>
                                        </tr>
                                    </table>
	                                </td>
	                                <td align="center">
	                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><img alt="" src="../images/title_ic02.gif" align="left" /><font color="408BEF"><strong>메탄 년도별 매출액 추이</strong></font></td>
