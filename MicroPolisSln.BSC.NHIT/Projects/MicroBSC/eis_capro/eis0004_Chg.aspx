<%@ Page Language="C#" AutoEventWireup="true" CodeFile="eis0004_Chg.aspx.cs" Inherits="eis_eis0004_Chg" %>
                ...
                <tr>
                    <td>
                        <table border=0 width=100% height="100%">
                            <tr>
                                <td class="subTitle">
                                    <img src="../images/icon/title_ic02.gif" align="absbottom" />계획 및 생산 추이 (락탐)
                                </td>
                            </tr>
                            <tr>
                                <td width=100%>
                                    <DCWC:Chart ID="Chart2" runat="server" ImageUrl="~/TempImages/ChartPic_#SEQ(300,3)" Palette="Dundas" Width="800px" height="200px">
                                        <ChartAreas>
