...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="eis0004_Daily.aspx.cs" Inherits="eis_eis0004_Daily" %>
...
<%@ Register TagPrefix="MenuControl" TagName="MenuControl" Src="~/_common/lib/MenuControl.ascx" %>
        ...
        <!--- MAIN START --->
                ...
                <tr>
                    <td>
                        <table border=0 width=100%>
                            <tr>
                                <td class="subTitle">
                                    <img src="../images/icon/title_ic02.gif" align="absbottom" />생산량, 개획대비 실적 (락탐)
                                </td>
                            </tr>
                            <tr>
                                <td width=100%>
                                    <DCWC:Chart ID="Chart1" runat="server" ImageUrl="~/TempImages/ChartPic_#SEQ(300,3)" Palette="Dundas" Width="800px" height="200">
                                        <ChartAreas>
                ...
                <tr>
                    <td style="
                                width:100%;
                                height:expression(eval(document.body.clientHeight)-320);
                              ">
