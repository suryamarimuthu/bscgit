<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="BSC0302M2.aspx.cs" Inherits="BSC_BSC0302M2" ValidateRequest="false" %>
                        ...
                        <td>
                           <table class="tableBorder" cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
	                                ...
	                                <td class="cssTblContent" >
                                        <asp:TextBox ID="txtKpiName" runat="server" Width="70%" BorderWidth="0" ReadOnly="True" BackColor="whitesmoke"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="cssTblContent"><asp:Label ID="lblKpiType" runat="server"  width="100%" BorderWidth="0"></asp:Label></td>
                    ...
                    <tr style="height:100%;"> 
                        <td>
                            ...
                            <ig:UltraWebTab runat="server" ID="ugrdKpiStatusTab" Height="100%" ThreeDEffect="False" Width="100%" SelectedTab="0" AutoPostBack="True" OnTabClick="ugrdKpiStatusTab_TabClick">
                                    ...
                                    <ig:Tab Text="PARTⅠ KPI_기본정보" Key="1">
                                        ...
                                        <ContentTemplate>
		                                    ...
		                                    <table class="tableBorder" cellpadding="0" cellspacing="0" border="0" width="100%">
		                                        ...
		                                        <tr>
			                                        <td class="cssTblTitle" >KPI담당자</td>
			                                        <td class="cssTblContent" >
			                                           <asp:TextBox ID="txtChampionEmpName" runat="server" BorderWidth="0" ReadOnly="true" Width="69%"></asp:TextBox>
			                                           <img alt="" id="ibtnChampion" runat="server" src="../images/btn/b_008.gif" style="vertical-align:inherit; cursor:hand;" onclick="openDeptEmp('hdfChampionEmpId','txtChampionEmpName');" />
			                                           <asp:HiddenField ID="hdfChampionEmpId" runat="server" />
                                                    </td>
                                                    <td class="cssTblTitle">KPI 측정 유형</td>
		                                            <td class="cssTblContent">
		                                                <asp:DropDownList ID="ddlResultAchievementType" runat="server" CssClass="box01"></asp:DropDownList>
		                                            </td>
		                                        </tr>
		                                        <tr>
		                                            <td class="cssTblTitle">누적실적유형</td>
		                                            <td class="cssTblContent">
		                                                <asp:DropDownList ID="ddlResultTsCalcType" runat="server" AutoPostBack="True" onChange="return SetTermToTarget();" CssClass="box01"></asp:DropDownList>
		                                            </td>
		                                            <td class="cssTblTitle">구간산정방법</td>
		                                            <td class="cssTblContent">
		                                                <asp:DropDownList ID="ddlMeasurementGradeType" runat="server" CssClass="box01"></asp:DropDownList>
		                                            </td>
		                                        </tr>
		                                        <tr>
		                                            <td class="cssTblTitle"><%=this.GetText("LBL_00003", "평가단계")%></td>
		                                            <td class="cssTblContent">
		                                                <asp:DropDownList ID="ddlResultMeasurementStep" runat="server" AutoPostBack="True" CssClass="box01" OnSelectedIndexChanged="ddlResultMeasurementStep_SelectedIndexChanged"></asp:DropDownList>
		                                            </td>
		                                        ...
		                                        <tr>
			                                        <td class="cssTblTitle" align="center">지표 및 용어정의</td>
			                                        <td class="cssTblContent" colspan="3">
                                                        ...
                                                        <span id="spnWordDefinition" runat="server" style="height: 150px; width: 100%; overflow: auto;" ></span>
			                                        </td>
		                                        </tr>
		                                        <tr>
		                                            <td class="cssTblTitle" align="center" style="height:285px;">주기 및 목표설정</td>
		                                            <td class="cssTblContent"  colspan="3" style="height: 265px" valign="top">
		                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
		                                                    <tr>
		                                                        <td>
		                                                            <ig:UltraWebGrid id="ugrdTerm" 
                                                                        runat="server" 
                                                                        height="100%" 
                                                                        width="100%" 
                                                                        ImageDirectory="" 
                                                                        OnInitializeRow="ugrdTerm_InitializeRow" >
                                                                        <Bands>
                                                                            <ig:UltraGridBand>
                                                                                <AddNewRow View="NotSet" Visible="NotSet">
                                                                                </AddNewRow>
                                                                                <Columns>
                                                                                    <ig:UltraGridColumn BaseColumnName="YMD_DESC" HeaderText="평가년월" Key="YMD_DESC" Width="20%" AllowUpdate="No">
                                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                                        <CellStyle HorizontalAlign="Center"></CellStyle>
                                                                                    </ig:UltraGridColumn>
                                                                                    <ig:TemplatedColumn BaseColumnName="CHECK_YN" Key="CHECK_YN" Width="30%">
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="MS_PLAN" HeaderText="당월계획" Key="MS_PLAN" DataType="System.Double" Type="Custom" Width="20%" AllowUpdate="No" Format="###,###,##0.####">
                                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                                        <CellStyle HorizontalAlign="Right" BackColor="WhiteSmoke"></CellStyle>
                                                                                    </ig:UltraGridColumn>
                                                                                    <ig:UltraGridColumn BaseColumnName="TS_PLAN" HeaderText="누적계획" Key="TS_PLAN" DataType="System.Double" Type="Custom" Width="20%" AllowUpdate="No" Format="###,###,##0.####">
                                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                                        <CellStyle HorizontalAlign="Right" BackColor="WhiteSmoke"></CellStyle>
                                                                                    </ig:UltraGridColumn>
                                                                                    <ig:UltraGridColumn BaseColumnName="CLOSE_YN" DataType="System.String" HeaderText="마감" Key="CLOSE_YN" Width="10%">
                                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                                        <CellStyle HorizontalAlign="Center"></CellStyle>
                                                                                    </ig:UltraGridColumn>
                                                                                    <ig:UltraGridColumn BaseColumnName="KPI_REF_ID" DataType="System.Int32" Key="KPI_REF_ID" Hidden="true">
                                                                                    </ig:UltraGridColumn>
                                                                                    <ig:UltraGridColumn BaseColumnName="ESTTERM_REF_ID" DataType="System.Int32" Key="ESTTERM_REF_ID" Hidden="true">
                                                                                    </ig:UltraGridColumn>
                                                                                    <ig:UltraGridColumn BaseColumnName="YMD" Key="YMD" DataType="System.String" Hidden="true"></ig:UltraGridColumn>                                                            
                                                                                </Columns>
                                                                            </ig:UltraGridBand>
                                                                        </Bands>
		                                        ...
		                                        <tr>
		                                            <td class="cssTblTitle">등급구간설정</td>
		                                            <td class="cssTblContent" colspan="3">
		                                                <table  border="0" cellpadding="0" cellspacing="0" width="100%">
		                                                    <tr>
		                                                        <td style="width:50%;height:100%;">
		                                                            <ig:UltraWebGrid id="ugrdSignal" runat="server" height="170px" width="100%" OnInitializeLayout="ugrdSignal_InitializeLayout" OnInitializeRow="ugrdSignal_InitializeRow" >
                                                                        <Bands>
                                                                            <ig:UltraGridBand>
                                                                                <Columns>
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="IMAG_PATH" HeaderText="표시" Key="IMAG_PATH" DataType="System.Double" Type="Custom" Width="12%">
                                                                                        <Header Caption="표시">
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="THRS_DESC" HeaderText="구간" Key="THRS_DESC" DataType="System.Double" Type="Custom" Width="20%" >
                                                                                        <Header Caption="구간">
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="SET_MIN_VALUE" HeaderText="계량" Key="SET_MIN_VALUE" DataType="System.Double" Type="Custom" Width="12%">
                                                                                        <Header Caption="계량">
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="SET_TXT_VALUE" HeaderText="비계량" Key="SET_TXT_VALUE" DataType="System.String" Type="Custom" Width="18%">
                                                                                        <Header Caption="비계량">
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="ACHIEVE_RATE" HeaderText="달성율" Key="ACHIEVE_RATE" DataType="System.Double" Type="Custom" Width="12%">
                                                                                        <Header Caption="달성율">
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="POINT" HeaderText="점수" Key="POINT" DataType="System.Double" Type="Custom" Width="10%">
                                                                                        <Header Caption="점수">
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="SET_MAX_VALUE" HeaderText="계획" Key="SET_MAX_VALUE" DataType="System.Double" Type="Custom" Hidden="true">
                                                                                        <Header Caption="계획">
		                                                            ...
		                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
		                                                                    ...
		                                                                    <td>
		                                                                        <table  cellpadding="0" cellspacing="1" border="0" style="height:98%; width:100%;">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td><asp:Label ID="lblTitle" runat="server" Font-Bold="true" Text="측정산식"/></td>
                                                                                    </tr>
                                                                                </table>                                                                    
                                                                            </td>
		                                                                </tr>
		                                                                <tr>
		                                                                    <td style="height:45px; vertical-align:top;">
                                                                                <asp:TextBox ID="txtCalcFormMs" runat="server" Width="100%" TextMode="MultiLine" Height="45px"></asp:TextBox>
                                                                            </td>
		                                                                </tr>
		                                                                <tr>
		                                                                    <td>
                                                                                <table  cellpadding="0" cellspacing="1" border="0" style="height:98%; width:100%;">
                                                                                    <tr>
                                                                                        <td style="width:1%;"><img src= "../images/title/ma_t14.gif" alt="" /></td>
                                                                                        <td><asp:Label ID="Label1" runat="server" Font-Bold="true" Text="목표 및 등급구간 설정근거"/></td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
		                                                                </tr>
                                                                        ...
                                                                        <tr>
                                                                            <td style="height:20px; vertical-align:top;">
                                                                                <table  cellpadding="0" cellspacing="1" border="0" style="height:98%; width:100%;">
                                                                                    <tr>
                                                                                        <td style="width:1%;"><img src= "../images/title/ma_t14.gif" alt="" /></td>
                                                                                        <td><asp:Label ID="Label2" runat="server" Font-Bold="true" Text="첨부파일"/></td>
                                                                                        <td  style="width:70%;">
                                                                ...
                                                                <ig:UltraGridBand>
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <ig:UltraGridColumn BaseColumnName="YMD_DESC" FooterText="" HeaderText="년월"
                                                                            Key="YMD_DESC" Width="10%" AllowUpdate="No">
                                                                            <HeaderStyle HorizontalAlign="Center" />
                                                                            <Header Caption="년월">
                                                                                <RowLayoutColumnInfo OriginX="3" />
                                                                            </Header>
                                                                        ...
                                                                        <ig:UltraGridColumn BaseColumnName="CHECK_YN" Key="CHECK_YN" Hidden="true"></ig:UltraGridColumn>
                                                                    </Columns>
                                ...
                                <DefaultTabStyle BackColor="White" Height="20px" CssClass="cssTabStyleOff"></DefaultTabStyle>
                        ...
                        <td>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td align="right">
                                        <asp:ImageButton ID="iBtnInsert" ImageUrl="../images/btn/b_001.gif" runat="server" OnClientClick="return TranKpi('I');"  OnClick="iBtnInsert_Click"  />
                                        <asp:ImageButton ID="iBtnUpdate" ImageUrl="../images/btn/b_002.gif" runat="server" OnClientClick="return TranKpi('U');" OnClick="iBtnUpdate_Click"  />
                                        <asp:ImageButton ID="iBtnConfirm" ImageUrl="../images/btn/b_015.gif" runat="server" OnClientClick="return TranKpi('C');" OnClick="iBtnConfirm_Click"  />
                                        <asp:ImageButton ID="iBtnConfirmCancel" ImageUrl="../images/btn/b_178.gif" runat="server" OnClientClick="return TranKpi('R');" OnClick="iBtnConfirmCancel_Click"  />
                                        <asp:ImageButton ID="iBtnDelete" ImageUrl="../images/btn/b_004.gif" runat="server" OnClick="iBtnDelete_Click" OnClientClick="return TranKpi('D');" />
                                        <asp:ImageButton ID="iBtnUsed" ImageUrl="../images/btn/b_138.gif" runat="server" OnClientClick="return TranKpi('S');" OnClick="iBtnUsed_Click" />
