...
public partial class BSC_BSC0302M5 : AppPageBase
{
    #region ==========================[변수선언]================
    public string ICCB1
    {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.iBtnGoalTong.Visible = false;
        if (IChampion_User_YN.Equals("Y"))
    ...
    private void InitializeGrid(UltraWebGrid grid)
    {
        ...
        ch = new Infragistics.WebUI.UltraWebGrid.ColumnHeader(true);
        ch.Caption = "의지목표(GOAL)";  //_itarget_mod_name;
        ch.RowLayoutColumnInfo.OriginY = 0;
    ...
    protected void ugrdPlanA_InitializeLayout(object sender, LayoutEventArgs e)
    {
        //e.Layout.Bands[0].HeaderLayout.Reset();
        ...
        ugrdPlanA.DisplayLayout.Bands[0].HeaderLayout.Reset();

        int iIndex = 0;
        Infragistics.WebUI.UltraWebGrid.ColumnHeader ch;

        foreach (Infragistics.WebUI.UltraWebGrid.UltraGridColumn c in ugrdPlanA.DisplayLayout.Bands[0].Columns)
        {
            c.Header.RowLayoutColumnInfo.OriginY = 1;
            c.Header.RowLayoutColumnInfo.OriginX = iIndex;
            iIndex++;
        ...
        //ch.RowLayoutColumnInfo.SpanX = 1;
        //ch.Style.Height = Unit.Pixel(20);
        //ugrdPlanA.DisplayLayout.Bands[0].HeaderLayout.Add(ch);
        //ugrdPlanA.DisplayLayout.Bands[0].HeaderStyle.HorizontalAlign = HorizontalAlign.Center;
        ...
        ch = ugrdPlanA.DisplayLayout.Bands[0].Columns[0].Header;
        ch.RowLayoutColumnInfo.OriginY = 0;
        ch.RowLayoutColumnInfo.OriginX = 0;
        ch.RowLayoutColumnInfo.SpanY = 2;

        ch = ugrdPlanA.DisplayLayout.Bands[0].Columns[7].Header;
        ch.RowLayoutColumnInfo.OriginY = 0;
        ch.RowLayoutColumnInfo.OriginX = 7;
        ch.RowLayoutColumnInfo.SpanY = 2;

        ch = ugrdPlanA.DisplayLayout.Bands[0].Columns[8].Header;
        ch.RowLayoutColumnInfo.OriginY = 0;
        ch.RowLayoutColumnInfo.OriginX = 8;
        ch.RowLayoutColumnInfo.SpanY = 2;

        for (int i = 0; i < ugrdPlanA.DisplayLayout.Bands[0].Columns.Count; i++)
        {
            if (i == 0)
            {
                ugrdPlanA.DisplayLayout.Bands[0].Columns[i].Width = 80;
                ugrdPlanA.DisplayLayout.Bands[0].Columns[i].CellStyle.HorizontalAlign = HorizontalAlign.Center;
            }
            else if (i > 0 && i < 5)
            {
                ugrdPlanA.DisplayLayout.Bands[0].Columns[i].DataType = "System.Double";
                ugrdPlanA.DisplayLayout.Bands[0].Columns[i].Format = "###,###,###,###,###,###,##0.####";
                ugrdPlanA.DisplayLayout.Bands[0].Columns[i].CellStyle.HorizontalAlign = HorizontalAlign.Right;
            }
            else
            {
                //ugrdPlanA.DisplayLayout.Bands[0].Columns[i].Width = 100;
                //ugrdPlanA.DisplayLayout.Bands[0].Columns[i].CellStyle.HorizontalAlign = HorizontalAlign.Left;
            }
        }
    }

    protected void ugrdPlanA_InitializeRow(object sender, RowEventArgs e)
    {
    ...
    private void SetTermToGoal(bool isAddTargetYN, bool isCalcYN)
    {
        ...
        ugrdPlanA.Columns.FromKey("YMD_DESC").AllowUpdate = AllowUpdate.No;
        ugrdPlanA.Columns.FromKey("YMD_DESC").CellStyle.BackColor = Color.WhiteSmoke;
        if (this.hdfinitial_version_yn.Value == "Y")
        {
            strMS_PLAN = "MS_PLAN";
            strTS_PLAN = "TS_PLAN";
            strCheck = "ORI_CHECK_YN";
            ugrdPlanA.Columns.FromKey("MS_PLAN").AllowUpdate = AllowUpdate.Yes;
            ugrdPlanA.Columns.FromKey("TS_PLAN").AllowUpdate = AllowUpdate.Yes;
            ugrdPlanA.Columns.FromKey("MM_PLAN").AllowUpdate = AllowUpdate.No;
            ugrdPlanA.Columns.FromKey("TM_PLAN").AllowUpdate = AllowUpdate.No;

            ugrdPlanA.Columns.FromKey("MS_PLAN").CellStyle.BackColor = Color.White;
            ugrdPlanA.Columns.FromKey("TS_PLAN").CellStyle.BackColor = Color.White;
            ugrdPlanA.Columns.FromKey("MM_PLAN").CellStyle.BackColor = Color.WhiteSmoke;
            ugrdPlanA.Columns.FromKey("TM_PLAN").CellStyle.BackColor = Color.WhiteSmoke;
        }
        else
        {
            strMS_PLAN = "MM_PLAN";
            strTS_PLAN = "TM_PLAN";
            strCheck = "MOD_CHECK_YN";
            ugrdPlanA.Columns.FromKey("MS_PLAN").AllowUpdate = AllowUpdate.No;
            ugrdPlanA.Columns.FromKey("TS_PLAN").AllowUpdate = AllowUpdate.No;
            ugrdPlanA.Columns.FromKey("MM_PLAN").AllowUpdate = AllowUpdate.Yes;
            ugrdPlanA.Columns.FromKey("TM_PLAN").AllowUpdate = AllowUpdate.Yes;

            ugrdPlanA.Columns.FromKey("MS_PLAN").CellStyle.BackColor = Color.WhiteSmoke;
            ugrdPlanA.Columns.FromKey("TS_PLAN").CellStyle.BackColor = Color.WhiteSmoke;
            ugrdPlanA.Columns.FromKey("MM_PLAN").CellStyle.BackColor = Color.White;
            ugrdPlanA.Columns.FromKey("TM_PLAN").CellStyle.BackColor = Color.White;
        }
        ...
        for (int i = 0; i < intRow; i++)
        {
            ...
            if (_icheck_term == "Y")
            {
                dblTot += double.Parse(ugrdPlanA.Rows[i].Cells.FromKey(strMS_PLAN).Value.ToString());
                intChkRow += 1;
            }


            if (ugrdPlanA.Rows[i] != null)
            {
                ugrdPlanA.Rows[i].Cells.FromKey(strCheck).Value = _icheck_term;


                if (strCloseYn == "Y")
                {
                    ugrdPlanA.Rows[i].Cells.FromKey(strMS_PLAN).AllowEditing = AllowEditing.No;
                    ugrdPlanA.Rows[i].Cells.FromKey(strTS_PLAN).AllowEditing = AllowEditing.No;
                    ugrdPlanA.Rows[i].Cells.FromKey(strMS_PLAN).Style.BackColor = Color.WhiteSmoke;
                    ugrdPlanA.Rows[i].Cells.FromKey(strTS_PLAN).Style.BackColor = Color.WhiteSmoke;
                }
                else
                {
                    if (_icheck_term == "N")
                    {
                        ...
                        ugrdPlanA.Rows[i].Cells.FromKey(strMS_PLAN).Style.BackColor = Color.WhiteSmoke;
                        ugrdPlanA.Rows[i].Cells.FromKey(strTS_PLAN).Style.BackColor = Color.WhiteSmoke;
                        ugrdPlanA.Rows[i].Cells.FromKey(strMS_PLAN).Value = 0;
                        ugrdPlanA.Rows[i].Cells.FromKey(strTS_PLAN).Value = 0;

                        switch (PageUtility.GetByValueDropDownList(ddlResultTsCalcType))
                        {
                            case "SUM": // 단순합계
                                ugrdPlanA.Rows[i].Cells.FromKey(strTS_PLAN).Value = Math.Round(dblTot, 5);
                                break;
                            case "AVG": // 단순평균
                                ugrdPlanA.Rows[i].Cells.FromKey(strTS_PLAN).Value = (intChkRow == 0) ? dblTot : Math.Round((dblTot / intChkRow), 5);
                                break;
                            default:
                                break;
                        }
                    ...
                    else
                    {
                        if (this.hdfinitial_version_yn.Value == "Y")
                        {
                            ugrdPlanA.Rows[i].Cells.FromKey("MS_PLAN").AllowEditing = AllowEditing.Yes;
                            ugrdPlanA.Rows[i].Cells.FromKey("TS_PLAN").AllowEditing = AllowEditing.Yes;
                            ugrdPlanA.Rows[i].Cells.FromKey("MS_PLAN").Style.BackColor = Color.White;
                            ugrdPlanA.Rows[i].Cells.FromKey("TS_PLAN").Style.BackColor = Color.White;

                            ugrdPlanA.Rows[i].Cells.FromKey("MM_PLAN").AllowEditing = AllowEditing.No;
                            ugrdPlanA.Rows[i].Cells.FromKey("TM_PLAN").AllowEditing = AllowEditing.No;
                            ugrdPlanA.Rows[i].Cells.FromKey("MM_PLAN").Style.BackColor = Color.WhiteSmoke;
                            ugrdPlanA.Rows[i].Cells.FromKey("TM_PLAN").Style.BackColor = Color.WhiteSmoke;
                        }
                        else
                        {
                            ugrdPlanA.Rows[i].Cells.FromKey("MS_PLAN").AllowEditing = AllowEditing.No;
                            ugrdPlanA.Rows[i].Cells.FromKey("TS_PLAN").AllowEditing = AllowEditing.No;
                            ugrdPlanA.Rows[i].Cells.FromKey("MS_PLAN").Style.BackColor = Color.WhiteSmoke;
                            ugrdPlanA.Rows[i].Cells.FromKey("TS_PLAN").Style.BackColor = Color.WhiteSmoke;

                            ugrdPlanA.Rows[i].Cells.FromKey("MM_PLAN").AllowEditing = AllowEditing.Yes;
                            ugrdPlanA.Rows[i].Cells.FromKey("TM_PLAN").AllowEditing = AllowEditing.Yes;
                            ugrdPlanA.Rows[i].Cells.FromKey("MM_PLAN").Style.BackColor = Color.White;
                            ugrdPlanA.Rows[i].Cells.FromKey("TM_PLAN").Style.BackColor = Color.White;
                        }
                        ...
                        if (isCalcYN)
                        {
                            switch (PageUtility.GetByValueDropDownList(ddlResultTsCalcType))
                            {
                                case "SUM": // 단순합계
                                    ugrdPlanA.Rows[i].Cells.FromKey(strTS_PLAN).Value = Math.Round(dblTot, 5);
                                    ugrdPlanA.Rows[i].Cells.FromKey(strTS_PLAN).AllowEditing = AllowEditing.No;
                                    ugrdPlanA.Rows[i].Cells.FromKey(strTS_PLAN).Style.BackColor = System.Drawing.Color.WhiteSmoke;
                                    break;
                                case "AVG": // 단순평균
                                    ugrdPlanA.Rows[i].Cells.FromKey(strTS_PLAN).Value = (intChkRow == 0) ? dblTot : Math.Round((dblTot / intChkRow), 5);
                                    ugrdPlanA.Rows[i].Cells.FromKey(strTS_PLAN).AllowEditing = AllowEditing.No;
                                ...
                                case "OTS": // 누적만측정
                                    ugrdPlanA.Rows[i].Cells.FromKey(strMS_PLAN).AllowEditing = AllowEditing.No;
                                    ugrdPlanA.Rows[i].Cells.FromKey(strMS_PLAN).Style.BackColor = System.Drawing.Color.WhiteSmoke;
                                    ugrdPlanA.Rows[i].Cells.FromKey(strTS_PLAN).AllowEditing = (_icheck_term == "N") ? AllowEditing.No : AllowEditing.Yes;
                                    ugrdPlanA.Rows[i].Cells.FromKey(strTS_PLAN).Style.BackColor = (_icheck_term == "N") ? System.Drawing.Color.WhiteSmoke : System.Drawing.Color.White;
                                    ugrdPlanA.Rows[i].Cells.FromKey(strMS_PLAN).Value = 0;
                                    break;
                                default:
                                    //ugrdPlanA.Rows[i].Cells.FromKey(strTS_PLAN).Value          = 0;
                ...
                ugrdPlanA.Rows[i].Cells.FromKey("CHECK_YN").AllowEditing = AllowEditing.No;
                ugrdPlanA.Rows[i].Cells.FromKey("CHECK_YN").Style.BackColor = Color.WhiteSmoke;

                ugrdPlanA.Rows[i].Cells.FromKey("REPORT_YN").AllowEditing = AllowEditing.No;
                ugrdPlanA.Rows[i].Cells.FromKey("REPORT_YN").Style.BackColor = Color.WhiteSmoke;

                ugrdPlanA.Rows[i].Cells.FromKey("CLOSE_YN").AllowEditing = AllowEditing.No;
                ugrdPlanA.Rows[i].Cells.FromKey("CLOSE_YN").Style.BackColor = Color.WhiteSmoke;

                ugrdPlanA.Rows[i].Cells.FromKey("MS_TARGET").AllowEditing = AllowEditing.No;
                ugrdPlanA.Rows[i].Cells.FromKey("MS_TARGET").Style.BackColor = Color.WhiteSmoke;

                ugrdPlanA.Rows[i].Cells.FromKey("TS_TARGET").AllowEditing = AllowEditing.No;
                ugrdPlanA.Rows[i].Cells.FromKey("TS_TARGET").Style.BackColor = Color.WhiteSmoke;
            }
        }
    ...
    private void DoBinding_KpiTarget()
    {
        ...
        ugrdPlanB.DataSource = DT_TARGET;
        ugrdPlanB.DataBind();
    }
    ...
    private void DoSaving()
    {
        ...
        // KPI TARGET 
        ////////////////////////////////////////////////////
        int intRow = ugrdPlanA.Rows.Count;
        int intCol = ugrdPlanA.Columns.Count;
        DataTable rDT3 = new DataTable("BSC_KPI_TARGET");
        ...
        for (int i = 0; i < intRow; i++)
        {
            ...
            //rDR3["ITYPE"]                 = this.IType; //(ugrdPlanA.Rows[i].Cells.FromKey("ESTTERM_REF_ID").Value == null) ? "A" : "U";
            rDR3["ITYPE"] = "A";
            rDR3["ESTTERM_REF_ID"] = (ugrdPlanA.Rows[i].Cells.FromKey("ESTTERM_REF_ID").Value == null) ? this.IEstTermRefID : int.Parse(ugrdPlanA.Rows[i].Cells.FromKey("ESTTERM_REF_ID").Value.ToString());
            rDR3["KPI_REF_ID"] = (ugrdPlanA.Rows[i].Cells.FromKey("KPI_REF_ID").Value == null) ? this.IKpiRefID : int.Parse(ugrdPlanA.Rows[i].Cells.FromKey("KPI_REF_ID").Value.ToString());
            rDR3["KPI_TARGET_VERSION_ID"] = intTargetVersion; //(ugrdPlanA.Rows[i].Cells.FromKey("KPI_TARGET_VERSION_ID").Value == null) ? intTargetVersion : ugrdPlanA.Rows[i].Cells.FromKey("KPI_TARGET_VERSION_ID").Value;
            rDR3["YMD"] = (ugrdPlanA.Rows[i].Cells.FromKey("YMD").Value == null) ? "" : ugrdPlanA.Rows[i].Cells.FromKey("YMD").Value;
            rDR3["TARGET_MS"] = (ugrdPlanA.Rows[i].Cells.FromKey(strMS).Value == null) ? 0 : double.Parse(ugrdPlanA.Rows[i].Cells.FromKey(strMS).Value.ToString());
            rDR3["TARGET_TS"] = (ugrdPlanA.Rows[i].Cells.FromKey(strTS).Value == null) ? 0 : double.Parse(ugrdPlanA.Rows[i].Cells.FromKey(strTS).Value.ToString());
        ...
        {
            ltrScript.Text = JSHelper.GetAlertScript("정상적으로 처리되었습니다.", false);
            ltrScript.Text += "<script type='text/javascript'> document.location.href=document.location.href; </script>";
        }
        else
        {
            ltrScript.Text = JSHelper.GetAlertScript("처리시 오류가 발생되었습니다.", false);
