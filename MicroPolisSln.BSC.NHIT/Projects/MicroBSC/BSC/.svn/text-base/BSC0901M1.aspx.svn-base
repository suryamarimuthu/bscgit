<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BSC0901M1.aspx.cs" Inherits="BSC_BSC0901M1" EnableEventValidation="false" EnableViewState="true" ValidateRequest="false"  %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        {
            var objLine = window.document.getElementById("divAreaAppLine_1");
        ...
        function isConfirmDraft(App_Type) {
            if (App_Type == "S") {
                var content = document.getElementById("txtRtnReason").value;
                content = content.replace(/(^\s*)|(\s*$)/gi, "");

                if (content.length > 0) {
                    alert("반려사유가 있으면 진행할 수 없습니다.");
                    return false;
                }
            }
            else if (App_Type == "R") {
                var content = document.getElementById("txtAppOpinion").value;
                content = content.replace(/(^\s*)|(\s*$)/gi, "");

                if (content.length > 0) {
                    alert("결재의견이 있으면 진행할 수 없습니다.");
                    return false;
                }
            }
    ...
    <form id="form1" runat="server">
      <div id="divArea_T">
          <div id="divTitle" runat="server">
            <asp:Label ID="lblAppTitle" runat="server" Text="▒ 지표정의서 결재 ▒"></asp:Label>
          </div>
          <div id="divSmallTitle">
            <img alt="" src="../images/icon/icon_kpi.gif" style="vertical-align:middle;" /> 결재원문
          </div>
          <div id="divAppLine">
      ...
      <div id="divArea_B">
                 ...
                 <td colspan="4">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                         ...
                         <td id="td01" runat="server" style="width: 34%;"><asp:TextBox ID="txtAppOpinion" runat="server" Text="" TextMode="MultiLine" BackColor="#ffffff"></asp:TextBox></td>
                         <th id="th2" runat="server" style="width:60px; text-align:center; font-weight:bold;">반&nbsp;려&nbsp;사&nbsp;유</th>
                         <td id="td02" runat="server" style="width: 33%;"><asp:TextBox ID="txtRtnReason" runat="server" Text="" TextMode="MultiLine" ReadOnly="true"></asp:TextBox></td>
         ...
         <div id="divAreaAppLine_1" runat="server">
           <table border="0" cellpadding="0" cellspacing="0" width="100%" style="height:100%;" class="appTableTree">
             <tr>
               ...
               <td>
                <table width="100%" >
                    <tr>
                        ...
                        <td align="right" style="padding-right:5px;"><asp:ImageButton id="btnToUp" runat="server" ImageUrl="~/images/btn/btn_add_03.gif" OnClientClick="return AppLineMove('U');" />
                         <asp:ImageButton id="btnToDown" runat="server" ImageUrl="~/images/btn/btn_add_04.gif" OnClientClick="return AppLineMove('D');"  /></td>
                    </tr>
                </table>
               </td>
             </tr>
             <tr>
               <td style="width:38%; vertical-align:top; empty-cells:show;" rowspan="2">
                 <div id="divDeptTree" class="GridFrameStyle" style="width:100%; height:180px; overflow:scroll;">
	               ...
	               <ig:ultrawebgrid id="ugrdEmpList" runat="server" width="100%" Height="100%" OnInitializeRow="ugrdAppLine_InitializeRow">
	                <Bands>
                        <ig:UltraGridBand>
                      <Columns>
                        <ig:UltraGridColumn Key="LINE_STEP" BaseColumnName="LINE_STEP" Width="25px" FooterText="" HeaderText="NO" SortingAlgorithm="QuickSort">
                        ...
                        <ig:UltraGridColumn BaseColumnName="DEPT_NAME" HeaderText="부서" Key="DEPT_NAME" Width="85px" Hidden="false">
                            <Header Caption="부서">
                        ...
                        <DisplayLayout CellPaddingDefault="2" 
                                         ...
                                         SortingAlgorithmDefault="NotSet"
                                         Name="ugrdEmpList" 
                            ...
                            <FrameStyle CssClass="GridFrameStyle" Width="100%" Height="170px" Cursor="Hand"></FrameStyle>
                            <ClientSideEvents DblClickHandler="getSelectEmp" />
                        </DisplayLayout>
                    </ig:ultrawebgrid>
                 
               </td>
               <td style="width:57%; height: 350px; padding-right: 8px;" valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="height: 100%; vertical-align: top;">
                        <tr valign="top">
                            <td id="td1" valign="top" style="width: 100%; height: 100%;">
	                            <ig:ultrawebgrid id="ugrdAppLine" runat="server" width="100%" Height="100%" OnInitializeRow="ugrdAppLine_InitializeRow" OnInitializeLayout="ugrdAppLine_InitializeLayout">
                                    <Bands>
                                        <ig:UltraGridBand>
                                      <Columns>
                                        <ig:UltraGridColumn Key="LINE_STEP" BaseColumnName="LINE_STEP" Width="30px" FooterText="" HeaderText="선택" Hidden="false" AllowUpdate="No">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <Header Caption="NO" Title=""></Header>
                                            <CellStyle horizontalalign="Center" BackColor="whitesmoke" verticalalign="Middle"></CellStyle>
                                        </ig:UltraGridColumn>
                                        <ig:UltraGridColumn BaseColumnName="DEPT_NAME" HeaderText="부서" Key="DEPT_NAME" Width="130px" AllowUpdate="No">
                                            <Header Caption="부서">
                                                <RowLayoutColumnInfo OriginX="2" />
                                            </Header>
                                        ...
                                        <ig:UltraGridColumn BaseColumnName="EMP_NAME" HeaderText="성명" Key="EMP_NAME" Width="70px" AllowUpdate="No">
                                            <Header Caption="성명">
                                                <RowLayoutColumnInfo OriginX="1" />
                                            </Header>
         ...
         <div id="divAreaButton">
           ...
           <asp:ImageButton id="btnSanction" runat="server" ImageUrl="~/images/btn/b_022.gif" OnClick="btnSanction_Click" Visible="false" Width="61px" Height="19px" OnClientClick="return HasContent('txtAppOpinion')" />
           <asp:ImageButton id="btnReturn" runat="server" ImageUrl="~/images/btn/b_024.gif" OnClick="btnReturn_Click" Visible="false" Width="61px" Height="19px" OnClientClick="return HasContent('txtRtnReason')" />
