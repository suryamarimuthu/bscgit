<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BSC_INTRO2_M2.aspx.cs" Inherits="BSC_INTRO2_M2" ValidateRequest="false" %>
		            ...
		            <td valign="top" >
			            <div class="G_title">
				            <table  cellpadding="0" cellspacing="0" border="0" style="height:100%; width:100%;">
                                <tr>
                                    <td style="width:15px;"><img src= "../../images/title/ma_t14.gif" alt="" /></td>
                                    <td><asp:Label ID="Label16" runat="server" Font-Bold="true" Text="본부별 순위"/></td>
                                </tr>
                            </table>
			            </div>
