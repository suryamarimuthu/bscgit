<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BSC_INTRO1.aspx.cs" Inherits="BSC_INTRO1" MasterPageFile="~/_common/lib/MicroBSC.master" %>
...
<style type="text/css">
    ...
    .kpi_1{float:left;width:109px;height:105px;margin:0px 0px 0px 21px;background:url('../images/Intro/back_blackscore1.gif') no-repeat;}
    ...
    .kpi_2{float:left;width:180px;margin:0px 0px 0px 8px;border-bottom:1px solid #ccc;}
...
<%--
                <div class="score">
                    ...
                    <span class="score2"><asp:label ID="lblBONBUscore" runat="server" Text="0"></asp:label></span>
                    <span class="score3"><asp:label ID="lblTEAMscore" runat="server" Text="0"></asp:label></span><br/>
                    <span class="name1"><b><asp:label ID="lblUserName" runat="server" Text=""></asp:label></b>님</span>
                    <span class="name2"><asp:label ID="lblBONBUname" runat="server" Text=""></asp:label></span>
                    <span class="name3"><asp:label ID="lblTEAMname" runat="server" Text=""></asp:label></span>	
                	
                </div>--%>
                <div class="kpi_2">
		            <div><img src="../images/Intro/bar_kpi3.gif"/></div>
		            <%--<div style="height:3px;cursor:pointer;" onclick="return doMovingPage('2');">--%>
                                ...
                                <ig:UltraGridBand ColHeadersVisible="No">
                                    ...
                                    <Columns>
                                        <ig:TemplatedColumn BaseColumnName="RANK_ID" EditorControlID="" FooterText=""
                                            Format="" HeaderText="순위" Key="RANK_ID" Width="30px">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <Header Caption="순위">
                                                <RowLayoutColumnInfo OriginX="6" />
                                            </Header>
                                       ...
                                       <ig:TemplatedColumn BaseColumnName="DEPT_NAME" EditorControlID="" FooterText=""
                                            Format="" HeaderText="부서" Key="DEPT_NAME" Width="130px">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <Header Caption="부서">
                                                <RowLayoutColumnInfo OriginX="6" />
                                            </Header>
                                       ...
                                       <ig:TemplatedColumn BaseColumnName="SCORE_TS" EditorControlID="" FooterText=""
                                            Format="" HeaderText="등급" Key="SCORE_TS" Width="20px">
                                            <HeaderStyle HorizontalAlign="Center" />
                                            <Header Caption="등급">
                                                <RowLayoutColumnInfo OriginX="6" />
                                            </Header>
