<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BSC0901P1.aspx.cs" Inherits="BSC_BSC0901P1" %>
...
<%--:#f5f5f5, D3DBDE--%>
  ...
  <body style="margin-top:0px; margin-left:0px; margin-bottom:0px; margin-right:0px; background-color:#FFFFFF;">
    <form id="form1" runat="server">
      <div id="divArea_T">
          ...
          <div id="divSmallTitle">
            <img alt="" src="../images/icon/icon_kpi.gif" style="vertical-align:middle;" /> 문서번호&nbsp;:&nbsp;<asp:Label ID="lblDocNo" runat="server" Text=""></asp:Label>
          </div>
          <div id="divAppLine">
          ...
          <div id="divPrint">
            <img alt="인쇄" src="../images/btn/b_080.gif" Visible="false"  onclick="window.print();" />
          </div>
      </div>
      <div id="divArea_M" runat="server" style="height: 520px;">
               ...
               <tr>
                 <td colspan="4">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                         <th style="width:90px; text-align:center; font-weight:bold;">결&nbsp;재&nbsp;의&nbsp;견</th>
                         <td><asp:TextBox ID="txtAppOpinion" runat="server" Text="" TextMode="MultiLine"></asp:TextBox></td>
                         <th style="width:90px; text-align:center; font-weight:bold;">반&nbsp;려&nbsp;사&nbsp;유</th>
                         <td><asp:TextBox ID="txtRtnReason" runat="server" Text="" TextMode="MultiLine"></asp:TextBox></td>
                      </tr>
                    </table>
                 </td>
               </tr>
         ...
         <div id="divAreaAppLine" runat="server">
           <table border="2" cellpadding="0" cellspacing="0" width="100%" style="height:100%;" class="appTable">
             ...
             <tr>
               ...
               <td style="width:57%;">
	               <ig:ultrawebgrid id="ugrdAppLine" runat="server" width="100%" Height="280px" OnInitializeRow="ugrdAppLine_InitializeRow" OnInitializeLayout="ugrdAppLine_InitializeLayout">
	                <Bands>
                        <ig:UltraGridBand>
                        <AddNewRow View="NotSet" Visible="NotSet"></AddNewRow>
                      <Columns>
                    ...
                    <DisplayLayout CellPaddingDefault="2" Version="4.00" 
                     ...
                     StationaryMarginsOutlookGroupBy="True" TableLayout="Fixed">
                        ...
                        <FrameStyle BackColor="Window" BorderColor="#E7E7E7" BorderStyle="Solid"
                            BorderWidth="0px" Font-Names="Microsoft Sans Serif" Font-Size="8.25pt" Height="280px" Width="100%">
                        </FrameStyle>
                        <Pager>
                            <PagerStyle BackColor="LightGray" BorderStyle="Solid" BorderWidth="1px">
                                <BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White"></BorderDetails>
                        ...
                        <ClientSideEvents DblClickHandler="ugrdAppLine_DblClickHandler" MouseOverHandler="MouseOverHandler" />
                    </DisplayLayout>
                </ig:ultrawebgrid>
               </td>
             </tr>
                 ...
                 <table border="0" cellpadding="0" cellspacing="0" width="100%">
                   <tr>
                     ...
                     <td align="right" style="text-align:right;">
                         ...
                         <asp:ImageButton id="btnLineConfirm" runat="server" ImageUrl="~/images/btn/b_032.gif" OnClick="btnLineConfirm_Click" />
