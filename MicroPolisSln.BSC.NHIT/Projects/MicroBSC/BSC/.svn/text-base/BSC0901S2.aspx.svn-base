<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BSC0901S2.aspx.cs" Inherits="BSC_BSC0901S2" MasterPageFile="~/_common/lib/MicroBSC.master" %>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <asp:ImageButton ID="iBtnAppCancel" runat="server" ImageAlign="AbsMiddle" Height="19px" ImageUrl="../images/btn/b_210.gif" OnClick="iBtnAppCancel_Click" OnClientClick="return ShowMsg();" />
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <Bands>
                        <ig:UltraGridBand>
                            ...
                            <Columns>
                                ...
                                <ig:UltraGridColumn BaseColumnName="TXR_DATE" Key="TXR_DATE" Width="80px">
                                    <Header Caption="작성일자">
                                        <RowLayoutColumnInfo OriginX="1" />
                                    </Header>
                                    <CellStyle HorizontalAlign="Left"></CellStyle>
                    ...
                    <Bands>
                        <ig:UltraGridBand>
                            ...
                            <Columns>
                                ...
                                <ig:UltraGridColumn BaseColumnName="EMP_NAME" Key="EMP_NAME" Width="50px" FooterText="" HeaderText="결재자">
                                    <Header Caption="결재자">
                                ...
                                <ig:UltraGridColumn BaseColumnName="COMMENTS" Key="COMMENTS" Width="180px" FooterText="" HeaderText="결재의견">
                                    <Header Caption="결재의견">
                                ...
                                <ig:UltraGridColumn BaseColumnName="RETURN_REASON" Key="RETURN_REASON" Width="180px" FooterText="" HeaderText="반려사유">
                                    <Header Caption="반려사유">
