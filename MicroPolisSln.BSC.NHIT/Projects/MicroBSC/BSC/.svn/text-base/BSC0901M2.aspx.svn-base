<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BSC0901M2.aspx.cs" Inherits="BSC_BSC0901M2" EnableEventValidation="false" EnableViewState="true" ValidateRequest="false"  %>
    ...
    <form id="form1" runat="server">
      <div id="divArea_T">
          <div id="divTitle" runat="server">
            <asp:Label ID="lblAppTitle" runat="server" Text="▒ 목표합의서 결재 ▒"></asp:Label>
          </div>
             ...
             <tr>
               ...
               <td style="width:57%; height: 280px; padding-right: 8px;" valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="height: 200px; vertical-align: top;">
                        <tr valign="top">
                            <td id="td4" valign="top" style="width: 100%; height: 230px;">
