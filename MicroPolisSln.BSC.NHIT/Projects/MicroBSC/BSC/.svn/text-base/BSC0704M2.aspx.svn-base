<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false" CodeFile="BSC0704M2.aspx.cs" Inherits="BSC_BSC0704M2" %>
                        ...
                        <td>
                            <table border="0" cellpadding="0" cellspacing="0" class="tableBorder" width="100%"
                                ...
                                <tr>
                                    ...
                                    <td class="cssTblContent">
                                        <asp:CheckBox ID="chkPopUpYn" runat="server" Text="로그인시 팝업실행여부" />
                                    </td>
                                    <td class="cssTblTitle">
                                        작성일
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="cssTblContent" style="border-right: none;">
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%;">
                                            <tr>
                                                <td style="width: 50%;">
                                                    <ig:WebDateChooser ID="wdcFrom" runat="server" NullDateLabel="" Format="Short" Width="100%">
                                                ...
                                                <td style="width: 50%;">
                                                    <ig:WebDateChooser ID="wdcTo" runat="server" NullDateLabel="" Width="100%">
                                                        <CalendarLayout ShowMonthDropDown="False" ShowYearDropDown="False">
                                                        </CalendarLayout>
                                                    </ig:WebDateChooser>
                                                </td>
