<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="BSC0302M1.aspx.cs" Inherits="BSC_BSC0302M1" %>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="height:100%;">
	                                        ...
	                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
	                                            <tr>
	                                                ...
	                                                <td style="width:20px;">
	                                                    ...
	                                                    <asp:ImageButton ID = "iBtnKpiPoolList" runat="server" ImageUrl="../images/btn/b_034.gif" OnClientClick="return openKpiPoolList('hdfKpiPoolRefID','txtKpiName');" ImageAlign="AbsMiddle" />
                    ...
                    <tr style="height:100%;">
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0" style="width:100%; height:100%;">
                                <tr> 
                                    <td>
                                      <ig:UltraWebTab runat="server" ID="ugrdKpiStatusTab" Height="100%" ThreeDEffect="False" Width="100%"  SelectedTab="3" AutoPostBack="True" OnTabClick="ugrdKpiStatusTab_TabClick" >
                                          <Tabs>
                                              <ig:Tab Text="PARTⅠ KPI 정의" Key="1" >
                                                <Style Width="160px" Height="25px"/>
                                                  <ContentTemplate>
		                                            <table class="tableBorder" cellpadding="0" cellspacing="0" border="0" width="100%" style="height:100%;">
		                                                <tr>
			                                                <td class="cssTblTitle" style="width:20%;"><%=GetText("LBL_00001", "챔피언") %></td>
		                                                ...
		                                                <tr style="height:100%;">
			                                                ...
			                                                <td class="cssTblContent"><asp:TextBox ID="txtWordDefinition" runat="server" Width="100%" TextMode="MultiLine" Height="100%" Visible="true"></asp:TextBox></td>
		                                                </tr>
		                                                <tr>
			                                                <td class="cssTblTitle">
                                                                당월산식</td>
			                                                <td class="cssTblContent"><asp:TextBox ID="txtCalcFormMs" runat="server" Width="100%" TextMode="MultiLine" Height="40px"></asp:TextBox></td>		                    
		                                                </tr>
                                                        <tr>
                                                            <td class="cssTblTitle">
                                                                누계산식</td>
		                                                ...
		                                                <tr>
			                                                <td class="cssTblTitle">관련이슈</td>
			                                                <td class="cssTblContent">
			                                                  <asp:TextBox ID="txtRelatedIssue" runat="server" Width="100%" TextMode="MultiLine" Height="40px" Visible="true"></asp:TextBox>
			                                                  <asp:TextBox ID="txtMeasurementPurpose" runat="server" Width="100%" TextMode="MultiLine" Height="40px" Visible="false"></asp:TextBox>
                                                              <asp:FileUpload ID="fileDefinition" runat="server" Width="300px" Visible="false" /><asp:HyperLink ID="linkDefinition" runat="server" Visible="false"></asp:HyperLink>
			                                                </td>
		                                                </tr>
                                                        <%--<tr>
                                              ...
                                              <ig:TabSeparator><Style Width="1px" /></ig:TabSeparator>
                                              <ig:Tab Text="PARTⅡ KPI측정" Key="2">
                                                <Style Width="160px"  Height="25px" />
                                                  <ContentTemplate>
	                                                <table class="tableBorder" cellpadding="0" cellspacing="0" border="0" width="100%" style="height:100%;">
	                                                    <tr>
		                                                    <td class="cssTblTitle" style="width:10%;"><%=GetText("LBL_00002", "측정조직 담당자")%></td>
		                                                    <td class="cssTblContent" style="width:90%;">
		                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
		                                                            <tr>
		                                                                <td>
		                                                                    <asp:HiddenField ID="hdfMeasurementEmpId" Value="" runat="server" />		                                
		                                                                    <asp:TextBox ID="txtMeasurementEmpName" runat="server" Width="100%" BorderWidth="0" BorderStyle="None"></asp:TextBox>
		                                                                </td>
		                                                                <td style="width:83px;">
	                                                    ...
	                                                    <tr>
		                                                    <td class="cssTblTitle" style="width:20%;">데이터집계방법</td>
                                                            <td class="cssTblContent" style="width:80%;">
		                                                      <asp:TextBox ID="txtDataGetheringMethod" runat="server" Width="100%" Height="80px" TextMode="MultiLine"></asp:TextBox>
                                                            </td>
	                                                    </tr>
	                                                    <tr >
		                                                    <td class="cssTblTitle">데이터상세정의</td>
                                                            <td  style="height:150PX;" >
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%" style="height:100%;">
                                                                    <tr>
                                                                        <td style="height:100%;">
                                                                            <ig:ultrawebgrid id="ugrdDetail" runat="server" height="100%" width="100%" OnInitializeRow="ugrdDetail_InitializeRow" OnInitializeLayout="ugrdDetail_InitializeLayout">
                                                                             <Bands>
                                                                              <ig:UltraGridBand>
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <ig:TemplatedColumn Key="selchk" Width="25px">
                                                                                      <HeaderTemplate >
                                                                                        <img src="../images/checkbox.gif" alt="전제선택/해제" style="cursor:hand; vertical-align:middle;" onclick="selectChkBox('ugrdDetail')" />
                                                                                      </HeaderTemplate>
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="LEVEL1" HeaderText="Level1" Key="LEVEL1" Width="80px" NullText="">
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="LEVEL2" HeaderText="Level2" Key="LEVEL2" Width="80px" NullText="">
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="LEVEL3" HeaderText="Level3" Key="LEVEL3" Width="80px" NullText="">
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="RESULT_SOURCE" HeaderText="실적데이터원천" Key="RESULT_SOURCE" Width="150px" NullText="">
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="RESULT_CREATE_TIME" HeaderText="실적생성시기" Key="RESULT_CREATE_TIME" Width="130px" NullText="">
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="TARGET_SOURCE" HeaderText="데이터원천" Key="TARGET_SOURCE" Width="130px" NullText="">
                                                                                    ...
                                                                                    <ig:TemplatedColumn BaseColumnName="UNIT_TYPE_REF_ID" Key="UNIT_TYPE_REF_ID" EditorControlID="" Width="65px" FooterText="" HeaderText="단위" NullText="0">
                                                                                      <Header Caption="단위">
                                                                                      ...
                                                                                      <CellStyle HorizontalAlign="Center"></CellStyle>
                                                                                      <CellTemplate>
                                                                                        <asp:DropDownList ID="ddlDataUnit" CssClass="box01" runat="server" Width="100%" ></asp:DropDownList>
                                                                                      </CellTemplate>
                                                                                      <Footer Caption="">
                                                                                        <RowLayoutColumnInfo OriginX="10" />
                                                                                      </Footer>
                                                                                ...
                                                                                <DisplayLayout Version="4.00" AllowUpdateDefault="Yes" 
                                                                                 HeaderClickActionDefault="NotSet" Name="ugrdDetail" BorderCollapseDefault="Separate" RowSelectorsDefault="No" 
	                                                    ...
	                                                    <tr style="height:100%;">
		                                                    <td class="cssTblTitle">주기설정</td>
		                                                    <td  style="height:100%;" >
		                                                       <table border="0" cellpadding="0" cellspacing="0" width="100%" style="height:100%;">
                                                                   <tr>
                                                                       <td>
                                                                        측정 주기:<asp:dropdownlist id="ddlResultTermType" runat="server" CssClass="box01"></asp:dropdownlist>
                                                                       </td>
                                                                   </tr>
                                                                   <tr >
                                                                        <td style="height:100%;">
                                                                            <ig:UltraWebGrid id="ugrdTerm" runat="server" height="100%" width="600px" ImageDirectory="" OnInitializeRow="ugrdTerm_InitializeRow" OnInitializeLayout="ugrdTerm_InitializeLayout">
                                                                                <Bands>
                                                                                    <ig:UltraGridBand>
                                                          ...
                                                          <tr>
                                                              <td style="width:100%;" valign="top" colspan="2">
                                                                  <table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableBorder">
                                                                      <tr>
                                                                        <td class="cssTblTitle" align="center" style="width:80px;" rowspan="3">KPI 유형</td>
                                                                        <td style="background-color:White;" rowspan="3">
                                                                            <asp:DropDownList ID="ddlResultAchievementType" runat="server" CssClass="box01" >
                                                                            </asp:DropDownList></td>
                                                                        <td class="cssTblTitle" align="center" style="width:90px;" rowspan="3">누적실적유형</td>
                                                                        <td style="background-color:White;" rowspan="3">
                                                                            <asp:DropDownList ID="ddlResultTsCalcType" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlResultTsCalcType_SelectedIndexChanged" CssClass="box01" >
                                                                            </asp:DropDownList></td>
                                                                        <td class="cssTblTitle" align="center" style="width:90px;" rowspan="3">구간산정방법</td>
                                                                        <td style="background-color:White;" rowspan="3">
                                                                            <asp:DropDownList ID="ddlMeasurementGradeType" runat="server" CssClass="box01">
                                                                            </asp:DropDownList></td>
                                                                         <td class="cssTblTitle" align="center" style="width:80px;" rowspan="3">단위</td>
                                                                         <td style="background-color:White;" rowspan="3">
                                                                             <asp:DropDownList ID="ddlUnit" runat="server" CssClass="box01"> </asp:DropDownList>
                                                                         </td>
                                                                          <td align="center" class="cssTblTitle" rowspan="3" style="width:80px;"><%=this.GetText("LBL_00003", "평가단계") %></td>
                                                                          <td rowspan="3" style="background-color: white">
                                                                              <asp:DropDownList ID="ddlResultMeasurementStep" runat="server" AutoPostBack="True" CssClass="box01" OnSelectedIndexChanged="ddlResultMeasurementStep_SelectedIndexChanged">
                                                                              </asp:DropDownList></td>
                                                                      </tr>
                                                                      <tr>
                                                                          <td colspan = "10"></td>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
                                                                    <tr>
                                                                        <td style="height:310px;">
                                                                            <!------- 당초/수정계획 그리드 ---------------------------->
                                                                <ig:UltraWebGrid id="ugrdPlan" runat="server" height="100%" width="99%" OnInitializeLayout="ugrdPlan_InitializeLayout" OnInitializeRow="ugrdPlan_InitializeRow" >
                                                                        <Bands>
                                                                            <ig:UltraGridBand>
                                                                                <Columns>
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="TS_PLAN" HeaderText="누적" Key="TS_PLAN" DataType="System.Double" Type="Custom" Width="98px" Format="###,###.####">
                                                                                        <Header Caption="누적">
                                                                                            <RowLayoutColumnInfo OriginX="2" />
                                                                                        </Header>
                                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="TM_PLAN" HeaderText="누적" Key="TM_PLAN" DataType="System.Double" Type="Custom" Width="98px" Format="###,###.####">
                                                                                        <Header Caption="누적">
                                                                                            <RowLayoutColumnInfo OriginX="4" />
                                                                                        </Header>
                                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                    ...
                                                                    <tr>
                                                                        <td style="height:140px;">
                                                                            <!--------------------------------- 점수구간 그리드 ---------------------------->
                                                                    <ig:UltraWebGrid id="ugrdSignal" runat="server" height="100%" width="100%" OnInitializeLayout="ugrdSignal_InitializeLayout" OnInitializeRow="ugrdSignal_InitializeRow" >
                                                                        <Bands>
                                                                            <ig:UltraGridBand>
                                                                                <AddNewRow View="NotSet" Visible="NotSet">
                                                                                </AddNewRow>
                                                                                <Columns>
                                                                                    ...
                                                                                    <ig:UltraGridColumn BaseColumnName="SET_MIN_VALUE" HeaderText="계획" Key="SET_MIN_VALUE" DataType="System.Double" Type="Custom" Width="80px" Format="##,##0.00">
                                                                                        <Header Caption="계획">
                                                                                            <RowLayoutColumnInfo OriginX="3" />
                                                                                        </Header>
                                                                                        <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <!--------------------------------- 목표/실적, 점수 기울기 그래프 ---------------------------->
                                                              <ig:UltraWebTab runat="server" ID="ugrdGraphTab" Height="311px" ThreeDEffect="false" Width="100%">
                                                                  <Tabs>
                                                                              ...
                                                                              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="height:200px; vertical-align:top;">
                                                                                      <asp:Chart ID="chartTarget" runat="server" ImageUrl="~/TempImages/ChartPic_#SEQ(300,3)" Palette="None" Height="150px" Width="400px" >
                                                                                        <ChartAreas>
                                                                                            <asp:ChartArea BackColor="White" BorderColor="196, 196, 196"
                                                                                ...
                                                                                <tr>
                                                                                  <td style="height:100px; vertical-align:top;">
                                                                                     <ig:ultrawebgrid id="ugrdTRStatus" runat="server" OnInitializeRow="ugrdTRStatus_InitializeRow" OnInitializeLayout="ugrdTRStatus_InitializeLayout" Width="100%" Height="100%">
                                                                            ...
                                                                            <table border="0" cellpadding="0" cellspacing="0" >
                                                                                <tr>
                                                                                    <td style="height:145px; vertical-align:top;">
                                                                                      <asp:Chart ID="chartScore" runat="server" ImageUrl="~/TempImages/ChartPic_#SEQ(300,3)" Palette="None" Height="150px" Width="400px" >
                                                                                        <ChartAreas>
                                                                                            <asp:ChartArea BackColor="White"  BorderColor="196, 196, 196"
                                                                                                Name="Default" ShadowColor="Transparent">
                                                                                                <AxisX IsLabelAutoFit="False" LineColor="196, 196, 196" Interval="1">
                                                              ...
                                                              <table border="0" cellpadding="0" cellspacing="0" style="height:140px;width:100%">
                                                                    ...
                                                                    <td>
                                                                        <table  cellpadding="0" cellspacing="1" border="0" style="height:98%; width:100%;">
                                                                            <tr>
                                                                                ...
                                                                                <td><asp:Label ID="lblTitle" runat="server" Font-Bold="true" Text="목표 및 등급구간 설정근거"/></td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="height:75px; vertical-align:top;">
                                                                        <asp:TextBox ID="txtTargetReason" runat="server" TextMode="MultiLine" Height="100%" Width="100%"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <table  cellpadding="0" cellspacing="1" border="0" style="height:98%; width:100%;">
                                                                                        <tr>
                                                                                            <td style="width:1%;"><img src= "../images/title/ma_t14.gif" alt="" /></td>
                                                                                            <td><asp:Label ID="Label1" runat="server" Font-Bold="true" Text="첨부파일"/></td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                                                <td>&nbsp;
                                                                                    <asp:ImageButton ID="iBtnTargetFile_Up"   ImageUrl="../images/icon/gr_po05.gif" runat="server" OnClientClick="return mfUpload('hdfTargetReasonFile','UP')" />
                                                          ...
                                                          <ig:UltraWebGrid ID="ugrdInitiative" runat="server"  Width="100%" Height="98%" OnInitializeRow="ugrdInitiative_InitializeRow">
                                                            <Bands>
                                                                <ig:UltraGridBand>
                                                                    ...
                                                                    <Columns>
                                                                        <ig:UltraGridColumn BaseColumnName="ESTTERM_REF_ID" HeaderText="ESTTERM_REF_ID" Key="ESTTERM_REF_ID" Width="80px" Hidden="true">
                                                                            <HeaderStyle HorizontalAlign="Center" />
                                                                            <Header Caption="ESTTERM_REF_ID">
                                                                            </Header>
                                                                        ...
                                                                        <ig:TemplatedColumn BaseColumnName="INITIATIVE_PLAN" FooterText="" HeaderText="추진계획" Key="INITIATIVE_PLAN"
                                                                            Width="500px" CellMultiline="Yes">
                                                                            <HeaderStyle HorizontalAlign="Center" />
                                                                            <Header Caption="추진계획">
                                                                                <RowLayoutColumnInfo OriginX="4" />
                                                                            </Header>
                                                                            ...
                                                                            <CellTemplate>
                                                                              <asp:TextBox TextMode="MultiLine" Width="100%" Height="100%" id="txtINITIATIVE_PLAN" runat="server"></asp:TextBox>
                                                                            </CellTemplate>
                                                                            <Footer Caption="">
                                                                                <RowLayoutColumnInfo OriginX="4" />
                                                                            </Footer>
                                                                        </ig:TemplatedColumn>
                                                                        <ig:TemplatedColumn BaseColumnName="INITIATIVE_DO" FooterText="" HeaderText="추진내용" Key="INITIATIVE_DO"
                                                                            Width="250px" CellMultiline="Yes" Hidden="True">
                                                                            <HeaderStyle HorizontalAlign="Center" />
                                                                            <Header Caption="추진내용">
                                                                                <RowLayoutColumnInfo OriginX="5" />
                                                                            </Header>
                                                                            <CellStyle HorizontalAlign="Left" Wrap="True"></CellStyle>
                                                                            <CellTemplate>
                                                                              <asp:TextBox TextMode="MultiLine" Width="100%" Height="100%" id="txtINITIATIVE_DO" runat="server"></asp:TextBox>
                                                                            </CellTemplate>
                                                                            <Footer Caption="">
                                                                                <RowLayoutColumnInfo OriginX="5" />
                                                                            </Footer>
                                                                        </ig:TemplatedColumn>
                                                                        <ig:TemplatedColumn BaseColumnName="INITIATIVE_DESC" FooterText="" HeaderText="특이사항" Key="INITIATIVE_DESC"
                                                                            Width="250px" CellMultiline="Yes" Hidden="true">
                                                                            <HeaderStyle HorizontalAlign="Center" />
                                                                            <Header Caption="특이사항">
                                                                                <RowLayoutColumnInfo OriginX="6" />
                                                                            ...
                                                                            <CellStyle HorizontalAlign="Left" Wrap="True"></CellStyle>
                                                                            <CellTemplate>
                                                                              <asp:TextBox TextMode="MultiLine" Width="100%" Height="100%" id="txtINITIATIVE_DESC" runat="server"></asp:TextBox>
                                                                            </CellTemplate>
                                                                            <Footer Caption="">
                                                                                <RowLayoutColumnInfo OriginX="6" />
                                                                            </Footer>
                                                                ...
                                                                <Bands>
                                                                    <ig:UltraGridBand>
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <ig:UltraGridColumn BaseColumnName="PRJ_CODE" HeaderText="코드" Hidden="false" Key="PRJ_CODE" Width="70px">
                                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                                <CellStyle HorizontalAlign="Center">
                                                                                </CellStyle>
                                                                                <Header Caption="코드">
                                              ...
                                              <ig:Tab Text="PARTⅤ 정성평가기준 관리" Key="5" Visible="false">
                                                ...
                                                <ContentTemplate>
                                                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="height:100%;">
                                                    <tr>
                                                        <td style="height:25px;"><img src="../images/icon/subtitle.gif" alt="" />평가차수정보</td>
                                                        <td style="height:25px;"><img src="../images/icon/subtitle.gif" alt="" />평가주기별 가중치</td>
                                                    </tr>
                                                    <tr>
                                                      <td style="width:60%; height:450px;" valign="top">
                                                            <ig:UltraWebGrid ID="ugrdEstLevel" runat="server" Height="100%" Width="100%" ImageDirectory="" OnInitializeGroupByRow="ugrdEstLevel_InitializeGroupByRow">
                                                                <Bands>
                                                                    <ig:UltraGridBand>
                                                                        <AddNewRow View="NotSet" Visible="NotSet">
                                                                        </AddNewRow>
                                                                        <Columns>
                                                                            ...
                                                                            <ig:UltraGridColumn BaseColumnName="KPI_GROUP_REF_ID" HeaderText="지표군 코드"
                                                                            ...
                                                                            <ig:TemplatedColumn BaseColumnName="SETTLE_DEVIATION_YN" Key="SETTLE_DEVIATION_YN" EditorControlID="" 
                                                                               Width="35px" FooterText="" HeaderText="편차조정여부" Hidden="false">
                                                                            ...
                                                                            <ig:UltraGridColumn BaseColumnName="EST_DEPT_NAME" HeaderText="평가부서" Key="EST_DEPT_NAME" Width="100px" Hidden="True">
                                                                                <Header Caption="평가부서">
                                                                                    <RowLayoutColumnInfo OriginX="9" />
                                                                                </Header>
                                                                                <Footer>
                                                                            ...
                                                                            <ig:UltraGridColumn BaseColumnName="EST_USER_NAME" HeaderText="평가자" Key="EST_USER_NAME" Width="100px" Hidden="True">
                                                                                <Header Caption="평가자">
                                                                                    <RowLayoutColumnInfo OriginX="10" />
                                                                                </Header>
                                                                                <Footer>
                                                                            ...
                                                                            <ig:UltraGridColumn BaseColumnName="EST_EMP_ID" HeaderText="EST_EMP_ID" Key="EST_EMP_ID" Width="100px" Hidden="True">
                                                                            ...
                                                                            <ig:UltraGridColumn BaseColumnName="DESCRIPTINS" HeaderText="기타사항" Key="DESCRIPTINS" Width="210px" Hidden="false">
                                                                                <Header Caption="기타사항">
                                                                                    <RowLayoutColumnInfo OriginX="13" />
                                                                                </Header>
                                                                                <Footer>
                                                      ...
                                                      <td style="width:40%; height:450px;" valign="top">
                                                          <ig:ultrawebgrid id="ugrdQuestionTerm" runat="server" height="100%" width="100%" OnInitializeRow="ugrdQuestionTerm_InitializeRow" >
                                                             <Bands>
                                                              <ig:UltraGridBand>
                                                                <AddNewRow View="NotSet" Visible="NotSet"></AddNewRow>
                                                                <Columns>
                                                                    ...
                                                                    <ig:UltraGridColumn BaseColumnName="YMD" HeaderText="YMD" Hidden="false"
                                                                        Key="YMD" Width="60px">
                                                                        <Header Caption="평가년월">
                                                                            <RowLayoutColumnInfo OriginX="3" />
                                                                        </Header>
                                                                    ...
                                                                    <ig:UltraGridColumn BaseColumnName="WEIGHT" HeaderText="WEIGHT" Key="WEIGHT" DataType="System.Double" NullText="0" Width="60px" AllowUpdate="Yes">
                                                                        <Header Caption="가중치" >
                                                                            <RowLayoutColumnInfo OriginX="4" />
                                                                        </Header>
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                ...
                                                                <DisplayLayout Version="4.00" 
                                                                               ...
                                                                               HeaderClickActionDefault="NotSet" 
                                                                               Name="ugrdQuestionTerm" 
                                                                               BorderCollapseDefault="Separate" 
                                                                               RowSelectorsDefault="No" 
                                                                               RowHeightDefault="20px" 
                                                                               HeaderStyleDefault-Height="30px" 
                                                                               SelectTypeRowDefault="Single" 
                                                                               TableLayout="Fixed" 
                                                                               AutoGenerateColumns="False" 
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
	                            <tr>
	                                <td class="content" align="left">&nbsp;
	                                    <asp:ImageButton ID="iBtnAddTarget" ImageUrl="../images/btn/b_090.gif" runat="server" OnClientClick="return OpenTargetForm()" Visible="false" />
	                                    <asp:ImageButton ID="iBtnAddChildKpi" ImageUrl="../images/btn/b_092.gif" runat="server" OnClientClick="return OpenChildKpiForm()" Visible="false" />
	                                    <%--<a href="#null" onclick = "return doPoppingUpGoalTong();">골통팝업</a>--%>
	                                    <asp:ImageButton ID="iBtnGoalTong" ImageUrl="../images/btn/btn_goalinput.gif" runat="server" OnClientClick="return doPoppingUpGoalTong()" Visible="false" />
	                                </td>
		                            <td class="cssPopBtnLine">
		                                <asp:ImageButton ID="ImgBtnPrint" runat="server" ImageUrl="../images/btn/b_080.gif" Visible="false"  OnClick="ImgBtnPrint_Click" />
		                                ...
		                                <asp:ImageButton ID="iBtnDelete" ImageUrl="../images/btn/b_004.gif" runat="server" OnClick="iBtnDelete_Click" OnClientClick="return DeleteKpi();" />
                                        <asp:ImageButton ID="iBtnUsed" ImageUrl="../images/btn/b_138.gif" runat="server" OnClick="iBtnUsed_Click" />
        ...
        <tr>
            <td>
                ...
                <ig:UltraWebGridExcelExporter ID="ugrdEEP" runat="server" OnBeginExport="ugrdEEP_BeginExport" OnCellExporting="ugrdEEP_CellExporting" OnCellExported="ugrdEEP_CellExported" />
