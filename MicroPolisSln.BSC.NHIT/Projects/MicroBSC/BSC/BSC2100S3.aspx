<%@ Page Title="" Language="C#" MasterPageFile="~/_common/libNHIT/MicroBSC.master" AutoEventWireup="true" CodeFile="BSC2100S3.aspx.cs" Inherits="BSC_BSC2100S3" %>
            ...
            <Bands>
                <ig:UltraGridBand>
                    ...
                    <Columns>
                        ...
                        <ig:UltraGridColumn BaseColumnName="ALLEMP" HeaderText="실적 일괄 입력 담당자" Key="ALLEMP"  AllowUpdate="No"
                            Width="200px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <CellStyle HorizontalAlign="Center">
                            </CellStyle>
                        ...
                        <ig:UltraGridColumn HeaderText="IF당월실적" Key="CAL_RESULT_MS" BaseColumnName="CAL_RESULT_MS" Width="100px" Format="#,##0.00" Type="Custom" DataType="System.Double">
                            <HeaderStyle Wrap="true" HorizontalAlign="Center" />
                            <CellStyle HorizontalAlign="Right">
                            
                            </CellStyle>
                        </ig:UltraGridColumn>
                        <ig:UltraGridColumn HeaderText="IF누적실적" Key="CAL_RESULT_TS" BaseColumnName="CAL_RESULT_TS" Width="100px" Format="#,##0.00" Type="Custom" DataType="System.Double">
                            <HeaderStyle Wrap="true" HorizontalAlign="Center" />
                            <CellStyle HorizontalAlign="Right">
                            </CellStyle>
                        </ig:UltraGridColumn>
                        <ig:UltraGridColumn HeaderText="당월실적" Key="RESULT_MS" BaseColumnName="RESULT_MS" Width="100px"  Format="#,##0.00" Type="Custom" DataType="System.Double">
                            <HeaderStyle Wrap="true" HorizontalAlign="Center" />
                            <CellStyle HorizontalAlign="Right">
                            </CellStyle>
                        </ig:UltraGridColumn>
                        <ig:UltraGridColumn HeaderText="누적실적" Key="RESULT_TS" BaseColumnName="RESULT_TS" Width="100px"  Format="#,##0.00" DataType="System.Double">
                            <HeaderStyle Wrap="true" HorizontalAlign="Center" />
                            <CellStyle HorizontalAlign="Right">
                            </CellStyle>
                        </ig:UltraGridColumn>
    ...
    <td>
        ...
        <tr>
            <td align="center">
                ...
                <asp:Button runat="server" ID="btnIFMove" Text="IF실적 적용" OnClick="btnIFMove_Click" />
