<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BSC0304S2_dundas.aspx.cs" EnableEventValidation="false" Inherits="BSC_BSC0304S2_dundas" MasterPageFile="~/_common/lib/MicroBSC.master" %>
            ...
            <td align="left">
              <div style=" overflow:auto; width:100%; height:100%;">
                 <table border="0" cellspacing="0" cellpadding="0" style="width:100%; height:100%">
                  ...
                  <tr>
                    <td style="vertical-align:top;">
                     <div runat="server" id="block1"  style="display:block; margin-left: 1px; height:300px;">
                      <table border="0" cellpadding="0" cellspacing="0" style="width:100%; height:100%;">
                        <tr>
                          <td style="height:20px;">
                              <img src="../images/icon/subtitle.gif" alt="" /><b>&nbsp;실적정보 상세</b>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <ig:UltraWebGrid ID="ugrdKpiResultStatus" runat="server" Width="772px" OnInitializeLayout="ugrdKpiResultStatus_InitializeLayout" OnInitializeRow="ugrdKpiResultStatus_InitializeRow" >
                                <DisplayLayout CellPaddingDefault="2" 
                                    ...
                                    <FrameStyle CssClass="GridFrameStyle" Width="100%" Height="110%"></FrameStyle>
                          ...
                          <tr>
                              <td style="height:220px;">
                                <table border="0" cellpadding="0" cellspacing="0" style="width:100%; height:100%">
                                  <tr>
                                    <td style="height:20px;">
                                        <img src="../images/icon/subtitle.gif" alt="" /><b>&nbsp;원인 및 대책</b>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td style="width:50%; height:110px;">
                                        <table width="771px" border="0" cellpadding="2" cellspacing="1" style="background-color:#C2D2D6">
                                            <tr> 
                                                <td align="center" style="background-color:#94bac9; width:80px; color:#ffffff">원인분석<br /><br />                           
                                                ...
                                                <td style="height:110px; width:300px; background-color:#ffffff" align="center">
                                                ...
                                                <td style="height:110px; background-color:#FFFFFF" align="center">
                                                    <asp:TextBox ID="txtReason_Sum" runat="server" Height="100%" Width="300px" Rows="5" TextMode="MultiLine" ReadOnly="True"></asp:TextBox></td>
                                            </tr>
                                        </table>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td style="width:50%; height:110px;">
                                        <table width="771px" border="0" cellpadding="2" cellspacing="1" style="background-color:#C2D2D6">
                                            <tr> 
                                                <td style="background-color:#9FB0D5; width:80px; color:#ffffff" align="center">대책검토<br /><br />
                                                ...
                                                <td style="height:110px; width:300px; background-color:#ffffff"> 
                                                ...
                                                <td style="height:110px; background-color:#FFFFFF" align="center">
                                                    <asp:TextBox ID="txtPlan_Sum" runat="server" Height="100%" Width="300px" Rows="5" TextMode="MultiLine" ReadOnly="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width:100%; height:100%;">
                                  <tr>
                                    <td style="height:25px; width:385px;">
                                        <img src="../images/icon/subtitle.gif" alt="" /><b>&nbsp;Initiative 추진계획</b>
                                    </td>
                                  ...
                                  <tr>
                                    <td style="height:100px;  width:390px;">
                                       <asp:TextBox ID="txtINITIATIVE_PLAN" runat="server" Height="100%" Width="390px" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                    <td style="height:100px;">
                                       <asp:TextBox ID="txtINITIATIVE_DO" runat="server" Height="100%" Width="380px" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                  </tr>
                                </table>
                            </asp:Panel>
                              ...
                              <table style="border-width:0px; width:100%;">
                                <tr>
                                  <td style="height:25px; border-width:0px; vertical-align:bottom; text-align:left; font-weight:bold;">
                                      <img src="../images/icon/subtitle.gif" alt="" /><b>&nbsp;익월실적예측</b>
                                  </td>
                                </tr>
                              </table>
                        ...
                        <tr>
                          <td style="vertical-align:top;">
                              <table style="border-width:0px; width:100%;">
                                <tr>
                                  <td style="height:25px; border-width:0px; vertical-align:bottom; text-align:left; font-weight:bold;">
                                      <img src="../images/icon/subtitle.gif" alt="" /><b>&nbsp;예측차이분석</b>
                                  </td>
                                </tr>
                              </table>
                              <table width="100%" border="0" cellpadding="0" cellspacing="1" style="background-color:#C2D2D6">
                    ...
                    <td style="vertical-align:top;">
                     <div runat="server" id="block3"  style="display: block; margin-left: 1px; height:350px; vertical-align:top;">
                      <table border="0" cellpadding="0" cellspacing="0" style="width:100%; height:100%;">
                        <tr>
                          <td style="height:20px;">
                            <img src="../images/icon/subtitle.gif" alt="" /><b>&nbsp;Comunication</b>
                          </td>
                        </tr>
                        <tr>
                          <td style="vertical-align:top;">
