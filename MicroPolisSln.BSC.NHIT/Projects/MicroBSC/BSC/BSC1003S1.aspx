<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BSC1003S1.aspx.cs" Inherits="BSC_BSC1003S1" EnableEventValidation="false" MasterPageFile="~/_common/lib/MicroBSC.master" %>
                                                    ...
                                                    <ig:UltraGridBand>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <ig:UltraGridColumn BaseColumnName="OP_DEPT_NAME" EditorControlID="" FooterText=""
                                                                Format="" HeaderText="운영조직" Key="OP_DEPT_NAME" Width="120px">
                                                                <HeaderStyle HorizontalAlign="Center" />
                                                                <Header Caption="운영조직">
                                                            ...
                                                            <ig:TemplatedColumn BaseColumnName="KPI_NAME" EditorControlID="" FooterText=""
                                                                Format="" HeaderText="KPI 명" Key="KPI_NAME" Width="315px">
                                                                <HeaderStyle HorizontalAlign="Center" />
