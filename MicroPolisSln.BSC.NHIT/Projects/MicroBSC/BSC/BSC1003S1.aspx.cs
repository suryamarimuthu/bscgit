...
public partial class BSC_BSC1003S1 : AppPageBase
{
    #region 변수선언
    public string ICCB1
    {
    ...
    public void SetResultListGrid()
    {
        ...
        //2011.07.29 허성덕과장 요청으로 관리자권한자에게는 모든 MBO 실적보이도록
        int isAdmin = 0;
    ...
    protected void ugrdKpiResultList_InitializeRow(object sender, Infragistics.WebUI.UltraWebGrid.RowEventArgs e)
    {
        ...
        //if (drw["APP_STATUS"].ToString() == "N")
        //{
        //    e.Row.Cells.FromKey("APP_STATUS").Text = string.Format("<div class='stext'><img src='../images/icon_x.gif'></div>");
        //}
        //else
        //{
        //    e.Row.Cells.FromKey("APP_STATUS").Text = string.Format("<div class='stext'><img src='../images/icon_o.gif'></div>");
        //}
