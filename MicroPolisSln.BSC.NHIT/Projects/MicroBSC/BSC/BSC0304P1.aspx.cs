...
public partial class BSC0304P1 : AppPageBase
{
    ...
    protected void grvResultExpt_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            oTableCell.Text = "구분";
            oTableCell.Style.Add(HtmlTextWriterStyle.BackgroundColor, "rgb(212, 235, 249)");
            oTableCell.Style.Add(HtmlTextWriterStyle.Color, "#749fe4");
            oTableCell.Style.Add(HtmlTextWriterStyle.FontWeight, "bold");
            oGridViewRow.Cells.Add(oTableCell);

            oTableCell = new TableCell();
            oTableCell.Text = "[ 당  월 ]";
            oTableCell.ColumnSpan = 3;
            oTableCell.CssClass = "cssTblTitle";
            oGridViewRow.Cells.Add(oTableCell);
            ...
            //e.Row.Cells[0].Width = Unit.Pixel(90);
            //e.Row.Cells[1].Width = Unit.Pixel(90);
            //e.Row.Cells[2].Width = Unit.Pixel(90);
            //e.Row.Cells[3].Width = Unit.Pixel(90);
            //e.Row.Cells[4].Width = Unit.Pixel(90);
