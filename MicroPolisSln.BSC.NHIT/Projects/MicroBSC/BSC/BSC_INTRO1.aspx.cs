...
public partial class BSC_INTRO1 : AppPageBase
{
    ...
    {
        int score = Convert.ToInt32(e.Row.Cells.FromKey("SCORE_TS").Value);

        string imageUrl = "<img border='0' src='" + searchRankImg(score) + "'>";

        e.Row.Cells.FromKey("SCORE_TS").Text = imageUrl;
    ...
    protected void ugrdFAQ_InitializeRow(object sender, Infragistics.WebUI.UltraWebGrid.RowEventArgs e)
    {
        ...
        e.Row.Cells.FromKey("FAQ_QUESTION").Text = strText;
    ...
    private void SetRankGrid()
    {
        ...
        DataTable dtbizScore = bizScore.GetOrgRankBonbuInTeam(IEstTermRefID
                                         , IYmd
                                         , 0
