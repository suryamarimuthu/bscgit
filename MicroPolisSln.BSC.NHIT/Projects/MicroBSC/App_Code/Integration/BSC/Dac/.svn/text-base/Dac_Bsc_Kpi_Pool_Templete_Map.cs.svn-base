...
{
    public class Dac_Bsc_Kpi_Pool_Templete_MAP : DbAgentBase
    {
                                ...
                                , object create_user)
        {
            ...
            string query = @"
INSERT INTO BSC_KPI_POOL_TEMPLETE_MAP
  ( 
...
";
                                ...
                                , object kpi_pool_templete_id)
        {
            ...
            string query = @"
DELETE FROM BSC_KPI_POOL_TEMPLETE_MAP
...
";
        ...
        public DataTable SelectData_DB(object kpi_pool_templete_id)
        {

            string query = @"
SELECT KPI_POOL_TEMPLETE_ID  
     , KPI_POOL_REF_ID  
FROM BSC_KPI_POOL_TEMPLETE_MAP
...
";
            ...
            DataTable dt = DbAgentObj.FillDataSet(query, "BSC_KPI_POOL_TEMPLETE_MAP", null, paramArray, CommandType.Text).Tables[0];
            return dt;
        }
