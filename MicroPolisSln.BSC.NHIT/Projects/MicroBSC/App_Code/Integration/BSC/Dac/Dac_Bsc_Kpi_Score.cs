...
{
    public class Dac_Bsc_Kpi_Score : DbAgentBase
    {
        /// <summary>
        /// 부서의 월별 KPI 누적 실적
        /// </summary>
...
";
            ...
            DataTable dt = DbAgentObj.FillDataSet(strQuery, "BSC_KPI_RESULT_TARGET", null, paramArray, CommandType.Text).Tables[0];
            return dt;
        }
