...
namespace MicroBSC.PRJ.Dac
{
    ...
    /// -------------------------------------------------------------
    /// Class Name     : Dac_Prj_Task_Share
    /// Class Func     : PRJ_TASK_SHARE Table Data Access
    /// CREATE DATE    : 2008-04-10 오후 2:27:46
    ...
    /// UPDATE DESC    : 
    /// -------------------------------------------------------------
    public class Dac_Prj_Task_Share : DbAgentBase
    {
        #region ============================== [Fields] ==============================
        ...
        #region ============================== [Constructor] ==============================
        public Dac_Prj_Task_Share() { }
        public Dac_Prj_Task_Share(int iprj_ref_id, int itask_ref_id, int iemp_ref_id)
        {
            DataSet ds = this.GetOneList(iprj_ref_id, itask_ref_id, iemp_ref_id);
            DataRow dr;
        ...
        internal protected int InsertData_Dac
                (int iprj_ref_id, int itask_ref_id, int iemp_ref_id, int itxr_user)
        {
            ...
            int affectedRow = DbAgentObj.ExecuteNonQuery(GetQueryStringByDb("usp_PRJ_TASK_SHARE", "PKG_PRJ_TASK_SHARE.PROC_INSERT"), paramArray, CommandType.StoredProcedure, out col);
                ...
                (int iprj_ref_id, int itask_ref_id, int iemp_ref_id, int itxr_user)
        {
            ...
            int affectedRow = DbAgentObj.ExecuteNonQuery(GetQueryStringByDb("usp_PRJ_TASK_SHARE", "PKG_PRJ_TASK_SHARE.PROC_UPDATE"), paramArray, CommandType.StoredProcedure, out col);
                ...
                (int iprj_ref_id, int itask_ref_id, int iemp_ref_id, int itxr_user)
        {
            ...
            int affectedRow = DbAgentObj.ExecuteNonQuery(GetQueryStringByDb("usp_PRJ_TASK_SHARE", "PKG_PRJ_TASK_SHARE.PROC_DELETE"), paramArray, CommandType.StoredProcedure, out col);
        ...
        public DataSet GetOneList(int iprj_ref_id, int itask_ref_id, int iemp_ref_id)
        {
            ...
            DataSet ds = DbAgentObj.FillDataSet(GetQueryStringByDb("usp_PRJ_TASK_SHARE", "PKG_PRJ_TASK_SHARE.PROC_SELECT_ONE"), "PRJ_TASK_SHARE", null, paramArray, CommandType.StoredProcedure);
            return ds;
        }

        public DataSet GetAllList(int iprj_ref_id, int itask_ref_id, int iemp_ref_id)
        {
            IDbDataParameter[] paramArray = CreateDataParameters(4);
            ...
            DataSet ds = DbAgentObj.FillDataSet(GetQueryStringByDb("usp_PRJ_TASK_SHARE", "PKG_PRJ_TASK_SHARE.PROC_SELECT_ALL"), "PRJ_TASK_SHARE", null, paramArray, CommandType.StoredProcedure);
            return ds;
        }
        #endregion
    }
