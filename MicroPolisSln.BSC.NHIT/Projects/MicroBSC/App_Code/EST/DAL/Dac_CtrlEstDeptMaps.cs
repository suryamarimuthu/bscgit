...
{
    public class Dac_CtrlEstDeptMaps : DbAgentBase
    {
        public int Update(IDbConnection conn
                        ...
                        , int update_user)
        {
            string quey = @"UPDATE	EST_CTRL_EST_DEPT_MAP
        ...
        public int Insert(IDbConnection conn
                        ...
                        , int create_user)
        {
            string query = @"INSERT INTO	EST_CTRL_EST_DEPT_MAP(CTRL_ID
                                                                ,COMP_ID
								                                ,EST_DEPT_REF_ID
								                                ,CREATE_DATE
								                                ,CREATE_USER
        ...
        public int Delete(IDbConnection conn
                        ...
                        , int est_dept_ref_id)
        {
            string query = @"DELETE	EST_CTRL_EST_DEPT_MAP
