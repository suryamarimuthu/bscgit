...
{
    public class Biz_PointCtrlDetails
    {
        #region ============================== [Fields] ==============================
        ...
        private Dac_PointCtrlDetails _pointCtrlDetail = new Dac_PointCtrlDetails();
        #endregion
        ...
        public Biz_PointCtrlDetails()
        {

        }

        public Biz_PointCtrlDetails(string est_id
                                    , int estterm_ref_id
                                    , int estterm_sub_id
                                    , int estterm_step_id
                                    , int est_dept_id
                                    ...
                                    , int seq)
        {
            DataSet ds = _pointCtrlDetail.Select(est_id
                                                , estterm_ref_id
                                                , estterm_sub_id
                                                , estterm_step_id
                                                , est_dept_id
        ...
        public bool ModifyPointCtrlDetail(string est_id
                                        , int estterm_ref_id
                                        , int estterm_sub_id
                                        , int estterm_step_id
                                        , int est_dept_id
                                        ...
                                        , int update_user)
        {
            ...
            affectedRow = _pointCtrlDetail.Update(null
                                                , null
                                                , est_id
                                                , estterm_ref_id
                                                , estterm_sub_id
        ...
        public DataSet GetPointCtrlDetail(string est_id
                                        , int estterm_ref_id
                                        , int estterm_sub_id
                                        , int estterm_step_id
                                        , int est_dept_id
                                        ...
                                        , int seq)
        {
            return _pointCtrlDetail.Select(est_id
                                        , estterm_ref_id
                                        , estterm_sub_id
                                        , estterm_step_id
                                        , est_dept_id
        ...
        public bool AddPointCtrlDetail(string est_id
                                    , int estterm_ref_id
                                    , int estterm_sub_id
                                    , int estterm_step_id
                                    , int est_dept_id
                                    ...
                                    , int create_user)
        {
            ...
            affectedRow = _pointCtrlDetail.Insert(null
                                                , null
                                                , est_id
                                                , estterm_ref_id
                                                , estterm_sub_id
        ...
        public bool RemovePointCtrlDetail(string est_id
                                        , int estterm_ref_id
                                        , int estterm_sub_id
                                        , int estterm_step_id
                                        , int est_dept_id
                                        ...
                                        , int seq)
        {
            ...
            affectedRow = _pointCtrlDetail.Delete(null
                                                , null
                                                , est_id
                                                , estterm_ref_id
                                                , estterm_sub_id
