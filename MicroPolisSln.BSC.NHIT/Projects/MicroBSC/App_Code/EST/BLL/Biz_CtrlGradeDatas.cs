...
{
    public class Biz_CtrlGradeDatas
    {
        #region ============================== [Fields] ==============================
        ...
        private string 	_ctrl_grade_id;
        private string 	_ctrl_opinion;
        private DateTime 	_update_date;
        private int 	_update_user;

        private Dac_CtrlGradeDatas _ctrlGradeData = new Dac_CtrlGradeDatas();
        ...
        public string Ctrl_Grade_ID
        {
	        get 
	        {
		        return _ctrl_grade_id;
	        }
	        set
	        {
		        _ctrl_grade_id = value;
	        }
        }
        ...
        public Biz_CtrlGradeDatas()
        {
            
        }

        public Biz_CtrlGradeDatas(int comp_id
                                , string est_id
                                , int estterm_ref_id
                                , int estterm_sub_id
                                , int estterm_step_id
                                ...
                                , int ctrl_seq)
        {
            DataSet ds = _ctrlGradeData.Select( comp_id
                                            , est_id
                                            , estterm_ref_id
                                            , estterm_sub_id
                                            , estterm_step_id
	        ...
	        if(ds.Tables[0].Rows.Count == 1)
	        {
		        ...
		        _ctrl_grade_id  = (dr["CTRL_GRADE_ID"]  == DBNull.Value) ? "" : (string) dr["CTRL_GRADE_ID"];
        ...
        public bool ModifyCtrlGradeData(  int comp_id
                                        , string est_id
                                        , int estterm_ref_id
                                        , int estterm_sub_id
                                        , int estterm_step_id
                                        ...
                                        , int update_user)
        {
            ...
            affectedRow = _ctrlGradeData.Update(null
                                            , null
                                            , comp_id
                                            , est_id
                                            , estterm_ref_id
        ...
        public DataSet GetCtrlGradeData(  int comp_id
                                        , string est_id
                                        , int estterm_ref_id
                                        , int estterm_sub_id
                                        , int estterm_step_id
                                        ...
                                        , int ctrl_seq)
        {
            return _ctrlGradeData.Select( comp_id
                                        , est_id
                                        , estterm_ref_id
                                        , estterm_sub_id
                                        , estterm_step_id
        ...
        public bool AddCtrlGradeData( int comp_id
                                    , string est_id
                                    , int estterm_ref_id
                                    , int estterm_sub_id
                                    , int estterm_step_id
                                    ...
                                    , int create_user)
        {
            ...
            int ctrl_seq = _ctrlGradeData.Count(comp_id, est_id, estterm_ref_id, estterm_sub_id, estterm_step_id, 0, 0, tgt_dept_id, tgt_emp_id) + 1;

            affectedRow = _ctrlGradeData.Insert(null
                                            , null
                                            , comp_id
                                            , est_id
                                            , estterm_ref_id
        ...
        public bool RemoveCtrlGradeData(  int comp_id
                                        , string est_id
                                        , int estterm_ref_id
                                        , int estterm_sub_id
                                        , int estterm_step_id
                                        ...
                                        , int ctrl_seq)
        {
            ...
            affectedRow = _ctrlGradeData.Delete(null
                                            , null
                                            , comp_id
                                            , est_id
                                            , estterm_ref_id
                            ...
                            , int ctrl_seq)
        {
            ...
            affectedRow = _ctrlGradeData.Count(comp_id
                                            , est_id
                                            , estterm_ref_id
                                            , estterm_sub_id
                                            , estterm_step_id
        ...
        public DataTable GetDataTableSchema() 
        {
            ...
            dataTable.Columns.Add("CTRL_GRADE_ID", typeof(string));
            dataTable.Columns.Add("CTRL_OPINION", typeof(string));
            dataTable.Columns.Add("CTRL_YN", typeof(string));
            dataTable.Columns.Add("BEFORE_GRADE_ID", typeof(string));
