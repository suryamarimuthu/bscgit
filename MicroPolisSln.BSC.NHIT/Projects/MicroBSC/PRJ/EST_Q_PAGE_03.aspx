<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EST_Q_PAGE_03.aspx.cs" Inherits="PRJ_EST_Q_PAGE_03" %>
<html>
...
<table  width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <td class="tableBorder" valign="top">
	                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
	                                        <tr>
		                                        ...
		                                        <td class="cssTblTitle" style="text-align:center;width:10%">점 수</td>
	                                        </tr>
	                                    </table>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                <tr>
	                                                ...
	                                                <td class="cssTblContent" style="width:40%" id="tdContent" runat="server">
                                                       ...
                                                       <asp:RadioButtonList ID="rBtnList" runat="server" style="cursor:pointer;" DataTextField="Q_ITEM_NAME" DataValueField="Q_ITM_ID" RepeatDirection="Horizontal" RepeatLayout="Flow" RepeatColumns="3" ></asp:RadioButtonList>
                                      ...
                                      <ItemTemplate>
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                             <tr>
                                                ...
                                                <td class="cssTblTitle"  style="width:120px" id="tdHeader" runat="server">평 가</td>
                                             ...
                                             <tr>
                                                ...
                                                <td class="cssTblContent" id="tdContent" runat="server">
                                                   <asp:TextBox ID="txtLevelValue" Visible="false" runat="server"></asp:TextBox>
                                                   <asp:RadioButtonList ID="rBtnList" runat="server" DataTextField="Q_ITEM_NAME" DataValueField="Q_ITM_ID" RepeatDirection="Horizontal" RepeatLayout="Flow" RepeatColumns="1"></asp:RadioButtonList>
                                                   <asp:HiddenField ID="tmpSubItmYN" runat="server" />
                                                   </td>
                                                 <td class="cssTblContent" >
                                                    <asp:Literal ID="ltrLevelPointData" runat="server"></asp:Literal>
    ...
    <tr>
        <td align="right" height="40" runat="server" id="tdImgBox">
            ...
            <a href="#null" onclick="window.close();">
                <img src="../images/btn/b_003.gif" height="19" border="0">
            </a>
            &nbsp
        </td>
    </tr>
