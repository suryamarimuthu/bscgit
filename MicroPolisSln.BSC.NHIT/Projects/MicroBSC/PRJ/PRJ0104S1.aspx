<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PRJ0104S1.aspx.cs" Inherits="PRJ_PRJ0104S1" %>
                                        ...
                                        <td valign="top" align="center">
                                            ...
                                            <div>
                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                    ...
                                                    <tr align="right">
                                                        <td style="height: 38px"><br/>
                                                            <asp:ImageButton ID="ibtnNoSelect" runat="server" ImageUrl="../images/btn/b_170.gif"
                                                                OnClick="ibtnNoSelect_Click" Visible="False" />
                                                            &nbsp;<a href="javascript:window.close();"><img src="../images/btn/b_003.gif" border=0 id="IMG1"/></a></td>
                                                    </tr>
                                                </table>
