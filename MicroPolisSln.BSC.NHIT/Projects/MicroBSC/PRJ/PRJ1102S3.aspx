<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PRJ1102S3.aspx.cs" Inherits="PRJ_PRJ1102S3" %>
...
<table border="0" cellspacing="2" cellpadding="0" style="height:320px; width:100%;">
    <tr>
        <td  style="vertical-align:top">
            <table class="tableBorder" cellpadding="0" cellspacing="0" border="0" style="height:60px; width:100%;">
                <tr>
                ...
                <tr>
                    <td class="tableTitle" align="center"  style=" width:120px; height:20px;"><b>실행과제</b></td>
                    <td class="tableContent" align="left" valign="middle">
                        <asp:TextBox ID="txtExecName" runat="server" Width="100%"  OnKeyPress="CheckKeys()" ReadOnly="true"></asp:TextBox> 
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td  style="vertical-align:top">
            <ig:UltraWebGrid ID="ugrdViewStg" runat="server" Width="100%" Height="260px" 
