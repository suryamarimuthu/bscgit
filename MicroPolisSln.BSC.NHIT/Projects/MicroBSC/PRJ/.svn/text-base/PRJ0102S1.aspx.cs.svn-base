...
public partial class PRJ_PRJ0102S1 : PrjPageBase
{
    private PrjScheuldeDataProvider _prjScheuldeDataProvider = null;
    ...
    public void SetFormInit()
    {
        ...
        this.WebMonthView1.StyleSheetFileName = "./styles/Office2007Blue/ig_webmonthview.css";
    ...
    protected void WebMonthView1_Load(object sender, EventArgs e)
    {
