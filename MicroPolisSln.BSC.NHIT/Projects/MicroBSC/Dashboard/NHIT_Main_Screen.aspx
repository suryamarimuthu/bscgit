<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NHIT_Main_Screen.aspx.cs" EnableEventValidation="false" Inherits="Dashboard_NHIT_Main_Table_Screen" MasterPageFile="~/_common/lib/MicroBSC.master" %>
...
<script id="Script1" type="text/javascript">
    ...
    document.getElementById('ctl01_Contents_hdfChartWidth').value = window.screen.width;
    document.getElementById('ctl01_Contents_hdfChartWidth').value = window.screen.height;

        //__doPostBack('<%=iBtnSearch.ClientID%>', '');

        //alert(document.getElementById('ctl00_Contents_hdfChartWidth').value);
        //        var ddl = document.getElementById('ctl00_Contents_ddlResolution');
        //        for (var i = 0; i < ddl.length; i++) {
        //            if (ddl.options[i].value == window.screen.width) {
        //                ddl.options[i].selected = true;
        //                var ddlValue = ddl.options[i].value;
        //                var temp = ddlValue.split('*');

        //                //alert(ddlValue);
        //                document.getElementById('ctl00_Contents_hdfChartWidth').value = temp[0];
        //                document.getElementById('ctl00_Contents_hdfChartHeight').value = temp[1];
                                    ...
                                    <td>
                                        <table  cellpadding="0" cellspacing="0" border="0" style="height:100%; width:100%;">
                                            <tr>
                                                ...
                                                <td align="right"><asp:Label ID="Label19" runat="server" Font-Bold="true" Text="(단위:백만원)"/></td>
                                            </tr>
                                        </table>
                                    </td>
                                 <tr>
