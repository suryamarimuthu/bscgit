...
public partial class Dashboard_NHIT_Main_Table_Screen : AppPageBase
{
    ...
    private Color ChartBorderLineColor = Color.FromArgb(181, 64, 1);
    ...
    public int WIDTH
    {
        get
        {
            ...
            {
                ViewState["WIDTH"] = GetRequestByInt("WIDTH", 0);
            }
    ...
    public int HEIGHT
    {
        get
        {
            ...
            {
                ViewState["HEIGHT"] = GetRequestByInt("HEIGHT", 0);
            }
    ...
    private void DoConfigurationChart()
    {
        ...
        ChartBorderLineColor = Color.FromArgb(181, 64, 1);
        //ChartBorderLineColor = GetChartColor2(0);
    }


    protected void Page_Load(object sender, EventArgs e)
    {
        DoConfigurationChart();
    ...
    private void DoDrawingJunsaChart2(DataTable dtChart, Chart chart)
    {
        ...
        Series series1 = MSCharts.CreateSeries(chart, "serPlan", "Default", "목표", null, SeriesChartType.Line, 1, GetChartColor2(0), Color.FromArgb(180, 26, 59, 105), Color.FromArgb(64, 0, 0, 0), 1, 9, Color.FromArgb(64, 64, 64), new Font("Trebuchet MS", 8));
        Series series2 = MSCharts.CreateSeries(chart, "serActl", "Default", "실적", null, SeriesChartType.Line, 1, GetChartColor2(1), Color.FromArgb(180, 26, 59, 105), Color.FromArgb(64, 0, 0, 0), 1, 9, Color.FromArgb(64, 64, 64), new Font("Trebuchet MS", 8));
    ...
    private void DoDrawingInPower(DataTable dtChart, Chart chart)
    {
        ...
        Series series1 = MSCharts.CreateSeries(chart, "serPlan", "Default", string.Format("목표 가득율 ({0}%)", target), null, SeriesChartType.Line, 1, GetChartColor2(0), Color.FromArgb(180, 26, 59, 105), Color.FromArgb(64, 0, 0, 0), 1, 9, Color.FromArgb(64, 64, 64));
        Series series2 = MSCharts.CreateSeries(chart, "serActl", "Default", "가득율", null, SeriesChartType.Line, 1, GetChartColor2(1), Color.FromArgb(180, 26, 59, 105), Color.FromArgb(64, 0, 0, 0), 1, 8, Color.FromArgb(64, 64, 64), new Font("Trebuchet MS", 8));//Font="Trebuchet MS, 4pt, style=Bold">
    ...
    private void DoDrawingEtcChart(DataTable dtChart, Chart chart, int colorCode)
    {
        ...
        Series series4 = MSCharts.CreateSeries(chart, "YG2", "Default", "영업(실적)", null, SeriesChartType.Line, 1, GetChartColor2(13), Color.FromArgb(180, 26, 59, 105), Color.FromArgb(64, 0, 0, 0), 1, 9, Color.FromArgb(64, 64, 64));
