...
public partial class NHIT_ORG_PRI_RANK : AppPageBase
{
    ...
    protected void UltraWebGrid5_InitializeRow(object sender, Infragistics.WebUI.UltraWebGrid.RowEventArgs e)
    {
        ...
        string url = "<a href='../BSC/BSC1004S1.ASPX?{1}'>{0}</a>";
    ...
    protected void UltraWebGrid4_SelectedRowsChange(object sender, Infragistics.WebUI.UltraWebGrid.SelectedRowsEventArgs e)
    {
        ...
        if (e.SelectedRows.Count > 0)
        {
            ...
            SetGrid5(DataTypeUtility.GetToInt32( ESTTERM_REF_ID), YMD, EST_DEPT_REF_ID);
        }
    ...
    private void SetGrid5(int estterm_ref_id, string ymd, string bonbu_id)
    {
        UltraWebGrid5.Clear();
